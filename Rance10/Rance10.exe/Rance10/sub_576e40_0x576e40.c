...
while (i != 0)
    if (edi + i == 2)
        ...
        if (sub_576130(x87_r0, x87_r1, *esi, *arg3).b != 0)
            int32_t ecx_17 = *var_24
            *var_24 = *esi
            *esi = ecx_17
    ...
    if (edi s<= i && edi s<= sub_576930(arg7))
        ...
        var_4c = esi
        sub_577850(eax_22, edx_7, ecx_12, var_4c, arg4, ebx_1, var_40_4)
        return 
    ...
    if (i s<= eax_2)
        ...
        var_4c = *eax_27
        sub_5778e0(eax_27, esi, var_24, var_4c, var_48_2, arg4)
        return 
    ...
    if (i s>= edi)
        ...
        var_18_1 = eax_15
        int32_t* eax_16 = sub_5779b0(eax_15, esi, var_24, eax_15)
        var_1c_1 = eax_16
        ...
        var_1c_1 = eax_7
        void* eax_8 = sub_577960(eax_7, arg4, esi, eax_7)
        var_18_1 = eax_8
    ...
    var_4c = arg8
    sub_576e40(eax_19, var_20_1, arg5, arg7, var_4c)
    i -= arg5
    arg3 = eax_19
    arg5 = var_18_1
    var_24 = eax_19
