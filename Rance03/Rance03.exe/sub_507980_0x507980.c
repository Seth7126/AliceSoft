...
struct partsengine::CSpriteEngineWrapper::VTable* edi = arg2
int32_t var_10_1 = 0
...
if (edi s<= 0)
    ...
    struct partsengine::CSpriteEngineWrapper::VTable* ebp_1 = arg3
    
    if (ebp_1 s<= 0)
        result.b = 0
    else
        struct partsengine::CSpriteEngineWrapper::VTable eax_3 = esi
        void* ebx_1 = data_75d4cc
        int32_t eax_4
        
        if (eax_3 == 0)
            eax_4 = sub_44f0e0(ebx_1 + 0x29c)
        else
            eax_4 = *(eax_3 + 8)
        ...
        void* eax_5 = sub_44e5c0(ebx_1 + 0x288)
        ...
        sub_505b50(esi, edi, ebp_1, 0, 0, 0, 0)
        int32_t eax_6 = sub_44f0e0(data_75d4cc + 0x29c)
        arg2 = &partsengine::CSpriteEngineWrapper::`vftable'
        int32_t* ecx_6 = edi * 3
        int32_t var_4_2 = 1
        
        if (sub_44da00(eax_6, ecx_6, ebp_1) != 0)
            ...
            if (ecx_8 != 0)
                ecx_8 = (*(*ecx_8 + 0x5c))(eax_9, 0, 0, eax_8, edi, 0, edi, ebp_1)
