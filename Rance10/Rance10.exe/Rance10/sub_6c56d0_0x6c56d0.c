...
if (data_7fcbdd == 0)
    ...
    result = MessageBoxA(data_7fcbe0, lpText, lpCaption, MB_OK)
else
    ...
    var_8_1.b = 1
    void* var_44
    sub_45aae0(sub_4175e0(sub_403490(&var_2c, ".============== usernotice::ShowMessage ", 0x30), 
        &var_2c, &var_44, \n"))
    int32_t var_30
    ...
    enum MESSAGEBOX_RESULT result_1 = 0xf
    int32_t var_34_1 = 0
    var_44.b = 0
    int32_t var_8_5 = 3
    var_8_5.b = 4
    void* var_5c
    sub_45aae0(sub_4175e0(sub_403490(&var_44, ".============== usernotice::ShowMessage ", 0x30), 
        &var_44, &var_5c, \n"))
    int32_t var_48
