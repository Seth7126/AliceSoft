...
int32_t (* var_c)(void* arg1) = sub_735e12
TEB* fsbase
...
if (ecx != 0 && eax_4 == 0xb)
    ...
    struct 
        common::SuicideRefCounter<class partsengine::CGUIView>::partsengine::CGUISpinBoxView::VTable
        ** eax_7 = sub_6e810c(0x160)
    struct 
        common::SuicideRefCounter<class partsengine::CGUIView>::partsengine::CGUISpinBoxView::VTable
        ** var_14_1 = eax_7
    int32_t var_8_1 = 0xb
    result = sub_4b76d0(eax_7, *(arg1 + 0x80), *(arg1 + 0x78), arg1)
