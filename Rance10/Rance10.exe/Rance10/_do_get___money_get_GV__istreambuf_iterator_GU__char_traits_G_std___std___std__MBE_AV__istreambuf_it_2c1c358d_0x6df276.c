// 函数: ?do_get@?$money_get@GV?$istreambuf_iterator@GU?$char_traits@G@std@@@std@@@std@@MBE?AV?$istreambuf_iterator@GU?$char_traits@G@std@@@2@V32@0_NAAVios_base@2@AAHAAV?$basic_string@GU?$char_traits@G@std@@V?$allocator@G@2@@2@@Z
// 地址: 0x6df276
...
void* const var_5c_4 = &data_6df282
...
int32_t arg_8
int32_t arg_10
sub_6db74c(&var_44, &arg_8, &arg_10, arg3, arg4, &var_2c)
int32_t var_8 = 0
...
void* const __saved_ebp_3 = &data_6df34f
