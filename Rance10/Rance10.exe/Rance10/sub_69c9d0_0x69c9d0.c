...
int32_t (* var_c)(void* arg1) = sub_7489e8
TEB* fsbase
...
int32_t* var_84 = &std::_Func_impl<class <lambda_df97c67c83b7108bc5053a8ee706a255>, class std::allocator<int>, void>::`vftable'{for `std::_Func_base<void>'}
