...
do
    ...
    int32_t eax_13
    int32_t edx_9
    edx_9:eax_13 = sx.q(sx.d(*(ebx + eax_1 + *(arg6 + 0x14))) + sx.d((eax_7 s>> 1).w) + 1)
    *ebp_2 += ((eax_13 - edx_9) s>> 1).w
    void* ebp_4 = *(var_24 + 0x14) + arg5
    int32_t edx_10 = *(arg4 + 0x14)
    ...
    int32_t eax_30
    int32_t edx_11
    edx_11:eax_30 = sx.q(sx.d(*(eax_1 + arg5 + *(arg6 + 0x14) + 2)) + 1 + sx.d((eax_23 s>> 1).w))
    int32_t ebx_6 = arg2 + 2 + esi
    *(ebp_4 + 2) += ((eax_30 - edx_11) s>> 1).w
    int32_t ebp_5 = *(var_24 + 0x14)
    int32_t edx_12 = *(arg4 + 0x14)
    ...
    *(arg5 + ebp_5 + 4) += ((eax_47 - edx_13) s>> 1).w
    ...
    int32_t edx_15
    edx_15:eax_64 =
        sx.q(sx.d(*((arg7 << 1) + 6 + arg5 + *(arg6 + 0x14))) + 1 + sx.d((eax_57 s>> 1).w))
    *(arg5 + ebp_6 + 6) += ((eax_64 - edx_15) s>> 1).w
    int32_t ebp_7 = *(var_24 + 0x14)
    int32_t edx_16 = *(arg4 + 0x14)
    ...
    int32_t edx_17
    edx_17:eax_81 =
        sx.q(sx.d(*((arg7 << 1) + 8 + arg5 + *(arg6 + 0x14))) + 1 + sx.d((eax_74 s>> 1).w))
    *(arg5 + ebp_7 + 8) += ((eax_81 - edx_17) s>> 1).w
    int32_t ebp_8 = *(var_24 + 0x14)
    int32_t edx_18 = *(arg4 + 0x14)
    ...
    *(arg5 + ebp_8 + 0xa) += ((eax_98 - edx_19) s>> 1).w
    ...
    int32_t edx_21
    edx_21:eax_115 =
        sx.q(sx.d(*((arg7 << 1) + 0xc + arg5 + *(arg6 + 0x14))) + 1 + sx.d((eax_108 s>> 1).w))
    *(arg5 + ebp_9 + 0xc) += ((eax_115 - edx_21) s>> 1).w
    int32_t ebp_10 = *(var_24 + 0x14)
    int32_t edx_22 = *(arg4 + 0x14)
    ...
    int32_t edx_23
    edx_23:eax_132 =
        sx.q(sx.d(*((arg7 << 1) + 0xe + arg5 + *(arg6 + 0x14))) + 1 + sx.d((eax_125 s>> 1).w))
