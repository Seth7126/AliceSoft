...
int32_t (* var_c)(void* arg1) = sub_6cf690
TEB* fsbase
...
if (arg2 != 0)
    if (arg2 u<= 0x1555555)
        eax_3 = sub_69adc6(arg2 * 0xc0)
        esi = eax_3
        struct _EXCEPTION_REGISTRATION_RECORD** var_18_1 = esi
    
    if (arg2 u> 0x1555555 || esi == 0)
        sub_69a4fc()
        noreturn

int32_t var_8_1 = 0
int32_t var_2c_2 = arg2
sub_65db00(eax_3, arg1[1], *arg1, esi)
int32_t eax_6
int32_t edx_1
...
if (eax_7 != 0)
    ...
    sub_65af30(eax_7, arg1[1])
    j__free(*arg1)

*arg1 = esi
arg1[2] = &esi[arg2 * 0x30]
void* result = &esi[ecx_5 * 0x30]
arg1[1] = result
fsbase->NtTib.ExceptionList = ExceptionList
return result
