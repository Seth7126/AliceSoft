...
if (*(arg1 + 0x498) == 0)
    xmm0_1 = _mm_cvtepi32_ps(zx.o(*(arg1 + 0x180))) f+ *(arg1 + 0x80)
    var_4 = xmm0_1
else
    ...
    if (edi_1 != 0)
        if (sub_5ed1f0(edi_1) != 0)
            eax_1 = (*(**(edi_1 + 0x2c) + 0x1c))()
        else
            eax_1 = 0
    else
        eax_1 = 0
    
    float xmm1_3 = _mm_cvtepi32_ps(zx.o(*(arg1 + 0x180))) f+ *(arg1 + 0x80)
...
int32_t result = sub_4a4170(arg1, *(arg1 + 0xe4))
xmm0_1 + var_4 - _mm_cvtepi32_ps(zx.o(result)) f+ *(arg1 + 0x4a8)
return result
