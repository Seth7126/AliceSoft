...
int32_t* eax_5 = *(arg1 + 0x1f0)
void* eax_7 = *(*(arg1 + 0x210) + 8)

if (eax_7 != 0 && sub_48d400(eax_7, arg1 + 0x16c) != 0)
    ...
    struct IInterface::partsengine::CFlatData::VTable** eax_18 =
        sub_492050(*(*(esi_1 + 0x28) + 4), arg1 + 0x16c)
    fsbase->NtTib.ExceptionList = ExceptionList
    return eax_18

int32_t* eax_19

if (*(arg1 + 0x108) u< 0x10)
    eax_19 = arg1 + 0xf4
else
    eax_19 = *(arg1 + 0xf4)

if (sub_44a260(eax_19) != 0)
    int32_t* eax_21 = sub_498b80(arg1, arg1 + 0xf4, arg1 + 0x1cc, arg1 + 0xa8, 1)
    fsbase->NtTib.ExceptionList = ExceptionList
    return eax_21
...
if (eax_22 == 0)
    ...
    char var_20_2 = 1
    int32_t (__stdcall* var_1c_2)(void* arg1, int32_t arg2, int32_t arg3, int32_t arg4) = sub_4d2f90
    eax_22 = &var_24

int32_t eax_26 = sub_498a70(arg1, arg1 + 0x1cc, eax_3, eax_4, arg1 + 0xa8, 1, eax_22, 1)
fsbase->NtTib.ExceptionList = ExceptionList
return eax_26
