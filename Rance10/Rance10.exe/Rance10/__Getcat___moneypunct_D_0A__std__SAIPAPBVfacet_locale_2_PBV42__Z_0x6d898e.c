// 函数: ?_Getcat@?$moneypunct@D$0A@@std@@SAIPAPBVfacet@locale@2@PBV42@@Z
// 地址: 0x6d898e
...
void* const var_60_3 = &data_6d899a
...
if (arg1 != 0 && *arg1 == 0)
    ...
    if (esi_1 == 0)
        ...
        *esi_1 = &std::moneypunct<uint16_t, 0>::`vftable'{for `std::_Mpunct<uint16_t>'}
...
int32_t var_60_2 = 3
fsbase->NtTib.ExceptionList = ExceptionList
void* const __saved_ebp_1 = &data_6d8a12
return 3
