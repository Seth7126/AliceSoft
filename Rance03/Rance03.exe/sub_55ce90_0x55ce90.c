...
if (ebx.b == 0)
    if (sub_59d350(&var_48) == 0)
        ...
        if (ebx.b != 0)
            ...
            if (sub_59d180(arg2, &(*U",}},},,,{,=,=,,},},{}=},{,=,,},{,=,,,,},},{,=")[0x16]) != 0)
                goto label_55d085
            
            sub_401f60(&var_28, &(*U",}},},,,{,=,=,,},},{}=},{,=,,},{,=,,,,},},{,=")[0x17])
            int32_t var_4_4 = 2
            ...
            if (ebx.b != 0)
                ...
                label_55d085:
                    ...
                    var_4_8.b = 5
                    void var_3c
                    sub_566010(arg3 + 0x1a8, sub_565f00(&var_3c, var_48, edi_1, &var_50))
                    result = 1
else
    result = 0
fsbase->NtTib.ExceptionList = ExceptionList
