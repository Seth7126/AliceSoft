...
int32_t eax_1
int32_t edx_1
eax_1, edx_1 = sub_647050(eax, &var_34, arg1, 0xffffffff, 0xffffffff)
int32_t result
...
if (edx_1 s< 0 || (edx_1 s<= 0 && eax_1 u< 0))
    ...
    while (true)
        ...
        if ((((zx.d(*(edx_2 + 0x11)) << 8 | zx.d(*(edx_2 + 0x10))) << 8 | zx.d(*(edx_2 + 0xf))) << 8
                | eax_4) == eax)
            int32_t eax_5 = sub_63d2a0(&i[0x1e], &var_34)
            ...
            while (i != 0xffffff88)
                ...
                void var_24
                eax_5 = sub_63d660(eax_5, &var_24, &i[0x1e], 1)
                
                if (eax_5 == 0)
                    break
                
                if (eax_5 s> 0)
                    eax_5 = sub_646ef0(arg2, &var_24)
            ...
            int32_t eax_8
            int32_t edx_7
            eax_8, edx_7 = sub_63cdc0(&var_34)
            eax_4 = eax_8 & edx_7
            
            if (eax_4 != 0xffffffff)
                int32_t eax_10
                int32_t edx_10
                eax_10, edx_10 = sub_63cdc0(&var_34)
        ...
        int32_t eax_9
        int32_t edx_9
        eax_9, edx_9 = sub_647050(eax_4, &var_34, i, 0xffffffff, 0xffffffff)
