...
if (result != edx)
    int16_t x87control
    int16_t x87status_1
    x87control, x87status_1 = __fldcw_memmem16(zx.w(sub_10015872()))
    int16_t x87status_2
    int16_t temp0_1
...
if (data_10023504 != 0)
    ...
    if (edx_4 != esi)
        int32_t eax_17 = sub_10015900(ecx_7, edx_4)
        int32_t var_10_1 = eax_17
        int32_t mxcsr = sub_10015f1f(eax_17.b)
        int32_t edx_5 = 0
        ...
        int32_t eax_19 = mxcsr & 0x6000
        
        if (eax_19 != 0)
            if (eax_19 == 0x2000)
                edx_5 |= 0x100
            else if (eax_19 == 0x4000)
                edx_5 |= 0x200
            else if (eax_19 == 0x6000)
                edx_5 |= 0x300
