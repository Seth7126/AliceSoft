...
int32_t var_1c = 0
char var_2c = 0
sub_402110(&var_2c, "DPPartsListWindow", 0x11)
int32_t var_4 = 0

if (*(arg1 + 0x5c) == 0)
    struct dpparts::CWindow::VTable** eax_5 = sub_69adc6(0x46c)
    var_4.b = 1
    struct dpparts::CWindow::dpparts::CDPPartsListWindow::VTable** ecx_3
    ...
    if (eax_5 == 0)
        ...
        ecx_3 = sub_656360(eax_5, edi_1, ebx_1, ecx_1, eax_10, eax_9, eax_8)
    
    var_4.b = 0
    *(arg1 + 0x5c) = ecx_3
    ecx_3[0xb2] = arg1 + 0x64
    *(*(arg1 + 0x5c) + 0x2c4) = *(arg1 + 0x54)
    sub_659500(*(arg1 + 0x5c))

void* ecx_6 = *(arg1 + 0x5c)
