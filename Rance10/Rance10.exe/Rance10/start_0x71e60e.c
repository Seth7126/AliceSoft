...
double xmm1[0x2] = data_757760
double xmm6[0x2] = data_757740
double xmm2[0x2] = data_757770
double xmm3[0x2] = data_757780
...
uint64_t xmm7_4[0x2] = _mm_slli_epi64(_mm_add_epi64(xmm1_2 & data_757720, data_757730), 0x2e)
...
int64_t xmm6_5 = _mm_or_pd(data_757710 & not.o(xmm2_4), _mm_slli_epi64(zx.o(eax_5 + 0x3ff), 0x34))
...
label_71e7d7:
    var_c = xmm0_9
    sub_7180f3(&arg3, &arg3, &var_c, edx_7)
    xmm0_9 = var_c
else if (ecx_5 == 0)
    edx_7 = 0xf
    goto label_71e7d7
