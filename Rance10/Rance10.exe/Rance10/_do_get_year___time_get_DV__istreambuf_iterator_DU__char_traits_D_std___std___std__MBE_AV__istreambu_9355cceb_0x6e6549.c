// 函数: ?do_get_year@?$time_get@DV?$istreambuf_iterator@DU?$char_traits@D@std@@@std@@@std@@MBE?AV?$istreambuf_iterator@DU?$char_traits@D@std@@@2@V32@0AAVios_base@2@AAHPAUtm@@@Z
// 地址: 0x6e6549
...
void* const var_30_3 = &data_6e6555
...
int32_t eax_2 = std::time_get<char,class std::istreambuf_iterator<char,struct std::char_traits<char> > >::_Getint(
    arg1, &arg_8, &arg_10, 0, 0x270f, &var_14)
*arg5 |= eax_2
...
arg2[1] = arg3
fsbase->NtTib.ExceptionList = ExceptionList
void* const __saved_ebp_1 = &data_6e65d7
return arg2
