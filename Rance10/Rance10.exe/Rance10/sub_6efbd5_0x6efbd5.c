...
Concurrency::details::ListArray<class Concurrency::details::ScheduleGroupBase>::DeleteElements(
    InterlockedFlushSList(arg1))
Concurrency::details::ListArray<class Concurrency::details::ScheduleGroupBase>::DeleteElements(
    InterlockedFlushSList(&arg1[1]))
Concurrency::details::ListArray<class Concurrency::details::ScheduleGroupBase>::DeleteElements(arg1
    ->__offset(0x10).d)
