...
int32_t (* var_c)(void* arg1) = sub_746a67
TEB* fsbase
struct _EXCEPTION_REGISTRATION_RECORD* ExceptionList = fsbase->NtTib.ExceptionList
int32_t __saved_ebp
int32_t eax_2 = __security_cookie ^ &__saved_ebp
int32_t var_2fc = eax_2
fsbase->NtTib.ExceptionList = &ExceptionList
int32_t* var_198 = arg1
int32_t var_194 = 0
int32_t* var_19c = arg1
*arg1 = 0
arg1[1] = 0
arg1[2] = 0
int32_t var_8_1 = 0
...
for (hFindFile_2 = hFindFile; hFindFile_2 != 0xffffffff; hFindFile_2 = hFindFile)
    ...
    if (dwFileAttributes != 0xffffffff && (dwFileAttributes.b & 0x16) == 0)
        if (arg1[1] == arg1[2])
            sub_4170d0(arg1, 1)
            hFindFile_2 = hFindFile
        
        char* eax_8 = arg1[1]
        char* var_198_1 = eax_8
        char* var_1a0_1 = eax_8
        var_8_2.b = 4
        
        if (eax_8 != 0)
            var_15c
            sub_403360(eax_8, &var_15c)
            hFindFile_2 = hFindFile
...
sub_680090(eax_12, arg1[1], ecx_6, edx_2 s/ 0x18, &var_190)
fsbase->NtTib.ExceptionList = ExceptionList
