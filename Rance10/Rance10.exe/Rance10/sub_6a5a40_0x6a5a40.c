...
if (ecx_6 != arg5)
    sub_6a5720(eax_2, arg2, arg3, arg4, ecx_6, "length does not match profile")
    return 0
...
if (ecx_14 u<= 0x1555554a)
    ...
    if (arg5 u>= eax_5)
        ...
        if (ecx_21 u>= 0xffff)
            sub_6a5720(eax_10, arg2, arg3, arg4, ecx_21, "invalid rendering intent")
            return 0
        
        if (ecx_21 u>= 4)
            sub_6a5720(eax_10, nullptr, arg3, arg4, ecx_21, "intent outside defined range")
        ...
        if (ecx_30 != 0x61637370)
            sub_6a5720(eax_13, arg2, arg3, arg4, ecx_30, "invalid signature")
            return 0
        
        int32_t eax_14 = *(arg6 + 0x44)
        
        if (eax_14 != 0xd6f60000)
            sub_6a5720(eax_14, nullptr, arg3, arg4, 0, "PCS illuminant is not D50")
        else
            eax_14 = *(arg6 + 0x48)
        ...
        if (ecx_39 != 0x47524159)
            if (ecx_39 != 0x52474220)
                sub_6a5720(eax_17, arg2, arg3, arg4, ecx_39, "invalid ICC profile color space")
                return 0
            
            if ((arg7 & 2) == 0)
                sub_6a5720(eax_17, arg2, arg3, arg4, 0x52474220, 
                    "RGB color space not permitted on grayscale PNG")
                return 0
        else if ((arg7 & 2) != 0)
            sub_6a5720(eax_17, arg2, arg3, arg4, 0x47524159, 
        ...
        if (ecx_49 u<= 0x6e6d636c)
            if (ecx_49 != 0x6e6d636c)
                if (ecx_49 == 0x61627374)
                    sub_6a5720(eax_20, arg2, arg3, arg4, 0x61627374, 
                        "invalid embedded Abstract ICC profile")
                    return 0
                
                if (ecx_49 == 0x6c696e6b)
                    sub_6a5720(eax_20, arg2, arg3, arg4, 0x6c696e6b, 
            ...
            sub_6a5720(eax_20, nullptr, arg3, arg4, var_18_6, 
        ...
        label_6a5ccd:
            ...
            if (not(cond:1_1))
                var_18_6 = ecx_49
                sub_6a5720(eax_20, nullptr, arg3, arg4, var_18_6, "unrecognized ICC profile class")
        ...
        sub_6a5720(eax_23, arg2, arg3, arg4, ecx_59, "unexpected ICC PCS encoding")
        return 0

sub_6a5720(eax_5, arg2, arg3, arg4, ecx_14, "tag count too large")
return 0
