...
int32_t (* var_c)(void* arg1) = sub_749bab
TEB* fsbase
...
void* const var_74_7 = &data_6dd2a5
...
int32_t var_8 = 0
int32_t var_54
struct std::ctype_base::std::ctype<wchar_t>::VTable* eax_5 =
    sub_633850(std::ios_base::getloc(arg5, &var_54))
...
int32_t var_18 = 7
int16_t var_2c = 0
sub_632bc0(&var_2c, ebx_1, 0)
int16_t* eax_6 = var_2c.d
int32_t var_8_2 = 1

if (var_18 u< 8)
    eax_6 = &var_2c

int32_t esi_2 = *(eax_5->vFunc_0 + 0x2c)
j_sub_4033e0()
esi_2(arg7, ebx_1 + arg7, eax_6, eax_37)
var_8_2.b = 2
int32_t var_5c
int32_t* eax_9 = sub_6d7479(std::ios_base::getloc(arg5, &var_5c))
var_8_2.b = 1
...
if (eax_10.b != 0x7f && eax_10.b s> 0)
    ...
    uint32_t edx_1 = zx.d(esi_5(arg2).w)
    uint32_t var_50_1 = edx_1
    ...
    while (true)
        ...
        ebx_1 -= ecx_12
        sub_6e3437(&var_2c, ebx_1, 1, edx_1.w)
...
if (eax_17 == 0x40)
    ...
    int16_t* var_68_3 = eax_27
    eax_26 = std::num_put<uint16_t,class std::ostreambuf_iterator<uint16_t,struct std::char_traits<uint16_t> > >::_Put(
        arg1, &var_5c, arg3, arg4)
else if (eax_17 == 0x100)
    int16_t* eax_22 = var_2c.d
    
    if (var_18 u< 8)
        eax_22 = &var_2c
    
    int32_t var_64_6 = edi_1
    int16_t* var_68_2 = eax_22
    int32_t* eax_23 = std::num_put<uint16_t,class std::ostreambuf_iterator<uint16_t,struct std::char_traits<uint16_t> > >::_Put(
        arg1, &var_5c, arg3, arg4)
    ...
    arg3 = *eax_18
    arg4 = eax_18[1]
    int16_t* eax_21 = var_2c.d
    
    if (var_18 u< 8)
        eax_21 = &var_2c
    
    int32_t var_64_5 = edi_1
    int16_t* var_68_1 = eax_21
    eax_26 = std::num_put<uint16_t,class std::ostreambuf_iterator<uint16_t,struct std::char_traits<uint16_t> > >::_Put(
        arg1, &var_5c, *eax_18, eax_18[1])

int16_t* ecx_16 = *eax_26
arg3 = ecx_16
int32_t edx_2 = eax_26[1]
...
int32_t* eax_33 = std::num_put<uint16_t,class std::ostreambuf_iterator<uint16_t,struct std::char_traits<uint16_t> > >::_Put(
    arg1, &var_5c, ecx_16, edx_2)
int32_t var_7c_2 = esi_8
int32_t var_80_2 = arg6
int16_t* ecx_17 = *eax_33
arg3 = ecx_17
...
fsbase->NtTib.ExceptionList = ExceptionList
void* const __saved_ebp_1 = &data_6dd55f
return arg2
