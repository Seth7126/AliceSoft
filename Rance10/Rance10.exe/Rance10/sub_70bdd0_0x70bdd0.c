...
if (data_7fd618 != 0)
    ...
    if (not(cond:0_1))
        ...
        *ecx = xmm0_4
        uint64_t xmm0_6[0x2] =
            __cmppd_xmmpd_mempd_immb(__andpd_xmmxuq_memxuq(xmm0_4, data_754f00), data_754f30, 4)
        ...
        var_14:4.d = 0x3ef
        var_14.d = &var_c
        sub_7180f3(&arg3, &arg5, var_14, var_c, arg1)
...
if (ecx_2.w != 0x7ff0)
    ...
    *arg5 = fconvert.d(st0_3)
    long double x87_r7_14 = fconvert.t(arg3) - st0_3
    var_14_1 = fconvert.d(x87_r7_14)
    var_c = fconvert.d(x87_r7_14)
    long double x87_r6_3 = float.t(0)
    x87_r6_3 - x87_r7_14
    double* eax_7
    eax_7.w = (x87_r6_3 < x87_r7_14 ? 1 : 0) << 8
    ...
    *esi = fconvert.d(x87_r7_8)
    ...
    int64_t var_34
    var_34.d = 0xffff
    var_14_1 = fconvert.d(__copysign())
    __ctrlfp(x87control_1, eax_5.w, 0xffff)

return fconvert.t(var_14_1)
