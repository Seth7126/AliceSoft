...
if (i != eax_10)
    ...
    do
        ...
        if (edi_3 != *ebp_1)
            void* ebp_3 = edi_3[0xa]
            EnterCriticalSection(*(ebp_3 + 0xc) + 4)
            int32_t ebx_2 = *(ebp_3 + 4)
            LeaveCriticalSection(*(ebp_3 + 0xc) + 4)
            
            if (ebx_2 != 1)
                ebp_1 = var_38_1
            else
                sub_54c280(edi_3[0xa])
                ebp_1 = var_38_1
...
int32_t** eax_22 = var_20
sub_417e10(&var_20, &var_24, *eax_22, eax_22)
