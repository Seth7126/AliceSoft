...
if ((arg1.b & 8) != 0 && (arg3 & 1) != 0)
    sub_10015ec7(x87_r0, 1)
    esi_1 &= 0xfffffff7
else if ((arg1.b & 4) != 0 && (arg3 & 4) != 0)
    sub_10015ec7(x87_r0, 4)
    esi_1 &= 0xfffffffb
else if ((1 & arg1.b) != 0 && (arg3 & 8) != 0)
    sub_10015ec7(x87_r0, 8)
    ...
    if (eax_2 == 0)
        ...
        if (p_4)
        label_10018e73:
            *ecx_3 = fconvert.d(fneg(fconvert.t(data_100218d8)))
        else
            *ecx_3 = fconvert.d(fconvert.t(data_100218d8))
    else if (eax_2 == 0x400)
        ...
        *ecx_3 = fconvert.d(fconvert.t(data_100218e8))
    else if (eax_2 == 0x800)
        ...
        if (not(p_2))
            *arg2 = fconvert.d(fconvert.t(data_100218d8))
        else
            *arg2 = fconvert.d(fneg(fconvert.t(data_100218e8)))
    else if (eax_2 == 0xc00)
        ...
        long double x87_r0_2 = fconvert.t(data_100218e8)
    ...
    if (not(p_5))
        ...
        var_30_1.q = fconvert.d(fconvert.t(*arg2))
        int32_t var_c
        st0 = sub_100189e1(var_30_1, &var_c)
        double var_18_1 = fconvert.d(st0)
        ...
        if (var_c - 0x600 s>= 0xfffffbce)
            ...
            var_18_1:6.w = (var_18_1:6.w & 0xf) | 0x10
            ...
            if (var_c - 0x600 s< 0xfffffc03)
                ...
                do
                    if ((var_18_1.b & 1) != 0 && esi_2 == 0)
                        esi_2 = 1
                    
                    var_18_1.d u>>= 1
                    
                    if ((var_18_1:4.b & 1) != 0)
                        var_18_1.d |= 0x80000000
            ...
            if (edx_1 != 0)
                var_18_1 = fconvert.d(fneg(fconvert.t(var_18_1)))
        else
            esi_2 = 1
            var_18_1 = fconvert.d(fconvert.t(var_18_1) * fconvert.t(0.0))
        
        *arg2 = fconvert.d(fconvert.t(var_18_1))
    
    if (esi_2 != 0)
        sub_10015ec7(x87_r0, 0x10)
    
    esi_1 &= 0xfffffffd

if ((arg1.b & 0x10) != 0 && (arg3 & 0x20) != 0)
    sub_10015ec7(st0, 0x20)
    esi_1 &= 0xffffffef
