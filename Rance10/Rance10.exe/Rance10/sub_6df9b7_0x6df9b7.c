...
void* const var_64_4 = &data_6df9c3
...
int32_t arg_8
int32_t arg_10
void* eax_2 = std::num_get<uint16_t,class std::istreambuf_iterator<uint16_t,struct std::char_traits<uint16_t> > >::_Getifld(
...
fsbase->NtTib.ExceptionList = ExceptionList
void* const __saved_ebp_1 = &data_6dfa62
return arg2
