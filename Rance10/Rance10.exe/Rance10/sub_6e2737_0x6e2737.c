...
if ((*(arg5 + 0x14) & 0x4000) != 0)
    int32_t var_8 = 0
    void var_4c
    int32_t* eax_2 = sub_6d73dc(std::ios_base::getloc(arg5, &var_4c))
...
fsbase->NtTib.ExceptionList = ExceptionList
void* const __saved_ebp_1 = &data_6e289a
return result
