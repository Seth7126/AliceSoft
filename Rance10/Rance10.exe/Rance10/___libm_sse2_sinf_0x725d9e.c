...
if (eax u> 0x457f)
    ...
    int32_t mxcsr
    int16_t x87control
    return _sin(mxcsr, x87control, fconvert.d(arg1))

float xmm1_1 = 10.1859159f f* arg1
uint64_t xmm3_1[0x2] = _mm_and_pd(data_79ed20, arg1)
...
double xmm3_4 = __xorpd_xmmxuq_memxuq(xmm3_3, data_79ed30)
