...
int32_t (* var_8)(void* arg1) = sub_6b8680
TEB* fsbase
        ...
        if (sub_45d110(&var_2c, arg3) == 0)
            if (*(arg3 + 0x20) == 0 || *(arg3 + 0x24) == *(arg3 + 0x1c))
                *(arg3 + 0x24) = *(*(arg3 + 0x24) + 4)
                sub_401f60(&var_44, 0x6dc5b4)
                var_4_1.b = 2
            else
                sub_401f60(&var_44, 0x6dc6fc)
                var_4_1.b = 3
        ...
        if (eax_17 != 0x10)
            if (eax_17 == 5)
                ...
                if (sub_4665c0(arg3) == 0)
                    sub_401f60(ecx_19, 0x6dc664)
                    var_4_1.b = 8
                    goto label_45e0c2
                
                sub_401f60(ecx_19, 0x6dc72c)
                var_4_1.b = 7
                var_74_4 = sub_4665c0(arg3)
                goto label_45e0cb
            
            sub_401f60(&var_44, 0x6dc7e0)
            var_4_1.b = 0xc
        label_45e0c2:
            var_74_4 = ebx
        label_45e0cb:
            ...
            var_4_1.b = 6
            var_4_1.b = 4
            ebx.b = sub_40c250(sub_4661e0(sub_4665c0(arg3), &var_44), 0x6dc744)
            sub_401fb0(&var_44)
            ...
            sub_45d430(&var_54, arg4)
            
            if (var_50_1 == 1)
                ebx.b = 1
                *(arg2 + 8) = 1
                *(arg2 + 0x24) = var_4c_1 ^ 0x65656565
            else if (var_50_1 != 2)
                ebx.b = 0
            else
                *(arg2 + 8) = 2
                int32_t xmm0_3
                result, xmm0_3 = sub_4591e0(var_48_1)
                *(arg2 + 0x28) = xmm0_3
                ebx.b = 1
