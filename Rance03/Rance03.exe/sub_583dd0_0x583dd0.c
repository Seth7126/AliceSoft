...
int32_t (* var_8)(void* arg1) = sub_6c74c0
TEB* fsbase
...
int32_t var_4 = 0
void* ebx = var_18
sub_59e480(arg1 + 0x34, ebx, *(arg1 + 0x14), *(arg1 + 0x154), *(arg1 + 0x155), *(arg1 + 0x156), 0)
...
if (eax_8 != 0)
    ...
    arg2.b = (*(**(arg1 + 0xcc) + 0xc))(edi_2, esi_1, (var_20_1 - esi_1) s>> 2, ebx).b != 0
