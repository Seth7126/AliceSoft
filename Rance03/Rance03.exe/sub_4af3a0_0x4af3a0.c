...
*arg2 = _mm_cvtepi32_ps(zx.o(*(edi + 0x58) + *(edi + 0x54))) + xmm1 f+ var_20
int32_t* eax_39 = &var_1c
float xmm0_20 = _mm_cvtepi32_ps(zx.o(*(edi + 0x50) + *(edi + 0x4c)))

if (xmm2 f<= var_14)
    eax_39 = &var_18

*arg3 = xmm0_20 f+ *eax_39
return arg3
