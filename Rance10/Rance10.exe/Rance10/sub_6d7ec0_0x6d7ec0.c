...
int32_t (* var_c)(void* arg1) = sub_74962d
TEB* fsbase
...
void* const var_80_8 = &data_6d7ecc
...
var_4c.b = eax_6.b
int32_t ebx_2 = _strcspn(arg7, &var_4c)
int32_t var_8 = 0
void var_5c
int32_t* eax_9 = sub_6d6aa9(std::ios_base::getloc(arg5, &var_5c))
...
int32_t esi_3 = *(*eax_9 + 0x2c)
j_sub_4033e0()
esi_3(arg7, arg8 + arg7, eax_10, eax_43)
var_8_2.b = 2
int32_t* eax_13 = sub_6d73dc(std::ios_base::getloc(arg5, &var_5c))
var_8_2.b = 1
std::_Debug_range2<class std::move_iterator<class std::_Vector_iterator<class std::_Vector_val<struct std::_Simple_types<class std::shared_ptr<struct Concurrency::details::_Task_impl<struct std::pair<uint8_t,class Concurrency::details::_CancellationTokenState*> > > > > > > >(
    &var_5c)
var_8_2.b = 3
...
while (true)
    ...
    ebx_2 -= ecx_17
    sub_6e338e(&var_2c, ebx_2, 1, edx_2.w)
...
fsbase->NtTib.ExceptionList = ExceptionList
void* const __saved_ebp_1 = &data_6d81ee
return arg2
