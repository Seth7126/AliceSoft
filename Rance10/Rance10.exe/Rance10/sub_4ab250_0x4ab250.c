    ...
    for (int32_t edx_1 = i[1]; j != edx_1; j = &j[3])
        ...
        if (eax_4 != ebx_1)
            ...
            if (eax_4 != ebx_1)
                ...
                struct _EXCEPTION_REGISTRATION_RECORD** eax_13 = sub_4aff10(i, arg2)
                fsbase->NtTib.ExceptionList = ExceptionList
                return eax_13

int32_t var_8_1 = 0
int32_t* var_28
int32_t* eax_7 = sub_4ac2b0(arg1 + 4, sub_4afc30(arg3, arg2, &var_28, arg3))
...
if (ecx_2 != 0)
    ...
    int32_t var_20
    eax_7 = sub_403160(esi_1, (var_20 - esi_1) s/ 0xc, 0xc)
