...
int32_t eax_5
int32_t edx
edx:eax_5 = muls.dp.d(0x66666667, *(arg2 + 0x1b8) - *(arg2 + 0x1b4))
...
if ((edx_1 u>> 0x1f) + edx_1 s<= 0)
    ...
    char var_40 = 0
    sub_402110(&var_40, 0x6e4c60, 0x13)
    int32_t var_4 = 0
    char* esi_1 = &var_40
    char* edx_2 = &var_40
    void* var_60_1 = arg1
    ...
    int32_t eax_10
    int32_t edx_3
    edx_3:eax_10 = muls.dp.d(0x66666667, *(arg2 + 0x1b8) - *(arg2 + 0x1b4))
    ...
    label_56325b:
        ...
        while (true)
            if (sub_563570(esi_2, *(arg2 + 0x1b4) + ebp_1).b == 0)
                result.b = 0
                break
            
            int32_t eax_16
            int32_t edx_5
            edx_5:eax_16 = muls.dp.d(0x66666667, *(arg2 + 0x1b8) - *(arg2 + 0x1b4))
            ...
            int32_t eax_23
            int32_t edx_8
            edx_8:eax_23 = muls.dp.d(0x66666667, *(arg2 + 0x1b8) - *(arg2 + 0x1b4))
            ebp_1 += 0x14
