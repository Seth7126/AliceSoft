...
int32_t (* var_8)(void* arg1) = sub_6b8700
TEB* fsbase
        ...
        if (sub_45d110(&var_2c, arg3) == 0)
            if (*(arg3 + 0x20) == 0 || *(arg3 + 0x24) == *(arg3 + 0x1c))
                *(arg3 + 0x24) = *(*(arg3 + 0x24) + 4)
                sub_401f60(&var_44, 0x6dc810)
                var_4_1.b = 2
            else
                sub_401f60(&var_44, 0x6dc778)
                var_4_1.b = 3
        ...
        if (eax_17 != 0x10)
            if (eax_17 == 5)
                ...
                if (sub_4665c0(arg3) == 0)
                    sub_401f60(ecx_19, 0x6dc8a4)
                    var_4_1.b = 8
                    goto label_45e490
                
                sub_401f60(ecx_19, 0x6dc7a8)
                var_4_1.b = 7
                var_74_4 = sub_4665c0(arg3)
                goto label_45e499
            
            sub_401f60(&var_44, 0x6dc8c0)
            var_4_1.b = 0xb
        label_45e490:
            var_74_4 = ebx
        label_45e499:
            ...
            var_4_1.b = 6
            var_4_1.b = 4
            ebx.b = sub_40c250(sub_4661e0(sub_4665c0(arg3), &var_44), 0x6dc7c0)
            sub_401fb0(&var_44)
