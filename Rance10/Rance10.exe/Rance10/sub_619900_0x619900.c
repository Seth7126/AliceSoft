...
int32_t var_48 = edx
arg1[0x7f] = ecx - 1
int32_t eax_5 = sub_6213c0(&arg1[0x52], edx)
int32_t result

if (eax_5 s>= 0)
    result = sub_405d30(&arg1[0x7d], eax_5)
else
    int32_t result_1 = 0xf
    int32_t var_1c_1 = 0
    char var_2c = 0
    sub_403490(&var_2c, 0x76d2c0, 0x1e)
    int32_t var_8_1 = 0
    var_8_1.b = 1
    char var_44
    sub_612230(arg1, "PAGE_COPY", sub_409350(&var_48, &var_2c, &var_44, &var_48))
    int32_t var_30
