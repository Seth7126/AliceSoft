...
int32_t (* var_8)(void* arg1) = sub_6cc93e
TEB* fsbase
...
if (data_75d534 == 0)
    ...
    if (result == 0)
        ...
        if (result == 0)
            ...
            struct filedialog::COpenFileDlg::VTable* const var_94_1 =
                &filedialog::COpenFileDlg::`vftable'
            ...
            if (eax_20 == eax_21)
                ...
                *(param0[0x1d8] + param0 + 0x35d) = 0
                eax_30 = GetOpenFileNameA(param0)
