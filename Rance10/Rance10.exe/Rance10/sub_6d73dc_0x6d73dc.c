...
void* const var_38_3 = &data_6d73e8
int32_t var_8_1 = 0xffffffff
fsbase->NtTib.ExceptionList = &ExceptionList
void var_18
std::_Lockit::_Lockit(&var_18, 0)
int32_t* result_2 = data_7fbd9c
int32_t var_8 = 0
int32_t* result_1 = result_2
int32_t* result = sub_62c5f0(arg1, sub_62c2f0(0x7fbd44))

if (result == 0)
    if (result_2 == 0)
        sub_6d8cbc(&result_1, arg1)
        result = result_1
        data_7fbd9c = result
...
fsbase->NtTib.ExceptionList = ExceptionList
void* const __saved_ebp_1 = &data_6d7478
return result
