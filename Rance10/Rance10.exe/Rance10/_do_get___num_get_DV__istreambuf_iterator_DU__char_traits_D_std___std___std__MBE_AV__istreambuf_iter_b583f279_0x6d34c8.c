// 函数: ?do_get@?$num_get@DV?$istreambuf_iterator@DU?$char_traits@D@std@@@std@@@std@@MBE?AV?$istreambuf_iterator@DU?$char_traits@D@std@@@2@V32@0AAVios_base@2@AAHAAK@Z
// 地址: 0x6d34c8
...
void* const var_60_3 = &data_6d34d4
...
int32_t arg_8
int32_t arg_10
int32_t eax_4 = __Stoulx(&var_34, &var_3c, 
...
fsbase->NtTib.ExceptionList = ExceptionList
void* const __saved_ebp_1 = &data_6d3575
return arg2
