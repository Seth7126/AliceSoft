...
if (ecx != 0)
    ...
    if (result != 0)
        ...
        do
            if (edi_1 s>= 0)
                ...
                if (edi_1 s< ecx_2)
                    ...
                    int32_t eax_11 = *(arg1 + 0x10) + ecx_3
                    float xmm3_2 = _mm_cvtepi32_ps(zx.o(i_2 + result_1 + edx_1))
                    float xmm4_2 = _mm_cvtepi32_ps(zx.o(edi_1))
                    sub_649080(eax_11, 0xffffffff, &result_2, xmm4_2, _mm_cvtepi32_ps(zx.o(ecx_3)), 
                        xmm3_2, _mm_cvtepi32_ps(zx.o(eax_11)), xmm4_2 * xmm1, 0, xmm3_2 * xmm1, 
                        0x3f800000)
                    edx_1 = var_10
                    result = result_1
                    i_1 += 6
        ...
        if (edx_1 s> 0)
            ...
            int32_t eax_14 = *(arg1 + 0x10) + ecx_5
            float xmm3_4 = _mm_cvtepi32_ps(zx.o(edx_1))
            float xmm1_3 = xmm3_4 / _mm_cvtepi32_ps(zx.o(eax_12))
            int32_t xmm0_14 = _mm_cvtepi32_ps(zx.o(eax_14))
            sub_649080(eax_14, 0xffffffff, &result_2, (zx.o(0)).d, _mm_cvtepi32_ps(zx.o(ecx_5)), 
                xmm3_4, xmm0_14, 0, 0, xmm1_3, 0x3f800000)
            i_1 += 6
