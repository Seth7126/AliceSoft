...
int32_t eax_1
int32_t edx_1
eax_1, edx_1 = sub_647930(arg1, edx)
...
int32_t result
int32_t edx_5
result, edx_5 = sub_6472b0(&var_14, edx_3 + 8, arg1, *(edx_3 + 4), &var_14, &var_8)
...
if (sub_647a80(eax_9 + 8, var_14, arg1, 0, 0, edi, ebx, arg1[2], arg1[3], var_8, var_4, eax_9 + 8)
        s< 0)
    return 0xffffff80
...
return sub_6489d0(arg1, edi, ebx)
