...
while (true)
    ...
    if (i[0x16] == 4)
        ...
        while (i != 0xffffff88)
            ...
            void var_24
            result = sub_6b8190(result, &var_24, &i[0x1e], 1)
            ...
            void* var_14
            void* ebp_1 = var_14
            result = sub_6c16a0(&i[0x94], &var_24)
    ...
    if (i[0x16] s>= 2)
        while (true)
            int32_t eax_5
            int32_t edx_4
            eax_5, edx_4 = sub_6c1ab0(result, &var_34, i, 0xffffffff, 0xffffffff)
...
label_6c2dd4:
    ...
    label_6c2dde:
        ...
        if (i[0x16] s< 3)
            if (i[1] == 0)
                result = sub_6c2000(&var_34, i[0x12], i, i[0x13], nullptr, nullptr, &var_34)
            ...
            label_6c2df6:
                ...
                if (result == ebx_3)
                    ...
                    i[0x17] = i_1
                    i[0x18] = result
                    sub_6b8170(&i[0x1e], i_1)
                    i[0x16] = 3
                    result = sub_6b7dc0(&i[0x1e], &var_34)
                    continue
