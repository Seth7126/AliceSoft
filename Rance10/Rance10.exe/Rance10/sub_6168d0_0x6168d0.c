...
int32_t var_64 = edx
arg1[0x7f] = ecx - 2
int32_t* eax_8 = sub_622840(&arg1[0x52], edx)
char* result
...
if (eax_8 != 0)
    void* eax_14 = sub_622840(&arg1[0x52], eax_4)
    
    if (eax_14 == 0)
        sub_403360(&var_44, 0x76c504)
        int32_t var_8_2 = 2
    ...
    if (sub_627ce0(eax_8, eax_14) != 0)
        result = sub_405d30(&arg1[0x7d], var_60)
    else
        void var_5c
        sub_403360(&var_5c, 0x76c4dc)
        int32_t var_8_3 = 4
        sub_612230(arg1, "A_ASSIGN", &var_5c)
        result = sub_403320(&var_5c)
else
    char* result_1 = 0xf
    int32_t* var_34_1 = eax_8
    var_44 = eax_8.b
    sub_403490(&var_44, 0x76c704, 0x20)
