...
void* esi_3 = arg1 + 0x1cc
void* edi = arg1 + 4
void* result

if (sub_58fde0(*(arg1 + 0x1ac), edi, esi_3) != 0)
    sub_583840(arg1, arg1 + 0x18c, esi_3)
    int32_t ecx_11
    ecx_11.b = 0
    ...
    *(arg1 + 0x1b0) = 0
    ...
    int32_t var_1c_1 = 0
    char var_2c = 0
    sub_403490(&var_2c, 0x768288, 0x38)
    int32_t var_8_1 = 0
