...
do
    ...
    int32_t eax_16
    int32_t edx_11
    edx_11:eax_16 = sx.q(sx.d(*(*(arg6 + 8) + ebp + eax_1)) + sx.d((eax_10 s>> 2).w) + 1)
    *eax_4 += ((eax_16 - edx_11) s>> 1).w
    int16_t* eax_22 = *(var_28 + 8) + 2 + arg5
    int32_t ecx_6 = *(arg4 + 8)
    ...
    int32_t eax_38
    int32_t edx_15
    edx_15:eax_38 = sx.q(sx.d(*(*(arg6 + 8) + eax_1 + arg5 + 2)) + 1 + sx.d((eax_31 s>> 2).w))
    *eax_22 += ((eax_38 - edx_15) s>> 1).w
    ...
    int32_t eax_57
    int32_t edx_20
    edx_20:eax_57 = sx.q(sx.d(*(*(arg6 + 8) + (arg7 << 1) + 4 + arg5)) + 1 + sx.d((eax_50 s>> 2).w))
    *(arg5 + ebp_4 + 4) += ((eax_57 - edx_20) s>> 1).w
    void* edx_23 = arg2 + 3 + esi
    int32_t ebp_5 = *(var_28 + 8)
    int32_t ecx_14 = *(arg4 + 8)
    ...
    int32_t eax_76
    int32_t edx_25
    edx_25:eax_76 = sx.q(sx.d(*(*(arg6 + 8) + arg5 + (arg7 << 1) + 6)) + 1 + sx.d((eax_69 s>> 2).w))
    *(arg5 + ebp_5 + 6) += ((eax_76 - edx_25) s>> 1).w
    ...
    int32_t eax_95
    int32_t edx_30
    edx_30:eax_95 = sx.q(sx.d(*(*(arg6 + 8) + arg5 + (arg7 << 1) + 8)) + 1 + sx.d((eax_88 s>> 2).w))
    *(arg5 + ebp_6 + 8) += ((eax_95 - edx_30) s>> 1).w
    void* edx_33 = arg2 + 5 + esi
    int32_t ebp_7 = *(var_28 + 8)
    int32_t ecx_24 = *(arg4 + 8)
    ...
    *(arg5 + ebp_8 + 0xc) += ((eax_133 - edx_40) s>> 1).w
    ...
    int32_t edx_45
    edx_45:eax_152 =
        sx.q(sx.d(*(*(arg6 + 8) + arg5 + (arg7 << 1) + 0xe)) + 1 + sx.d((eax_145 s>> 2).w))
