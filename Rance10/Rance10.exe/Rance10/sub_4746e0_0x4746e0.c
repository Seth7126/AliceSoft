...
int32_t (* var_c)(void* arg1) = sub_72ddc0
TEB* fsbase
...
if (edx_2 u>> 0x1f != neg.d(edx_2))
    ...
    if (eax_10 u< eax_6)
        ...
        int32_t var_8_1 = 0
        int32_t var_40_3 = ecx_7
        int32_t var_44_1 = 0.d
        int32_t var_48_1 = ecx_7
        char* var_18 = eax_15
        char* eax_16
        int32_t ecx_9
        eax_16, ecx_9 = sub_469260(eax_15, arg2, *arg1, eax_15)
        char* var_18_1 = eax_16
        int32_t var_40_4 = ecx_9
        int32_t var_44_2 = 0.d
        int32_t var_48_2 = ecx_9
        char* eax_17
        int32_t ecx_11
        eax_17, ecx_11 = sub_469260(eax_16, arg4, arg3, eax_16)
        char* var_18_2 = eax_17
        int32_t var_40_5 = ecx_11
        int32_t var_44_3 = 0.d
        int32_t var_48_3 = ecx_11
        sub_469260(eax_17, arg1[1], arg2, eax_17)
        int32_t ecx_14 = arg1[1] - *arg1
        int32_t* ecx_15 = *arg1
        
        if (ecx_15 != 0)
            sub_467940(ecx_15, arg1[1])
            void* esi_2 = *arg1
            sub_403160(esi_2, (arg1[2] - esi_2) s/ 0x38, 0x38)
        
        arg1[2] = &eax_15[eax_14 * 0x38]
        void* eax_31 = &eax_15[(eax_6 + ecx_14 s/ 0x38) * 0x38]
        arg1[1] = eax_31
        *arg1 = eax_15
        fsbase->NtTib.ExceptionList = ExceptionList
        return eax_31
    ...
    void** var_40_7 = arg3
    int32_t var_44_6 = 0.d
    void** var_48_5 = arg3
    sub_469260(eax_10, arg4, arg3, arg1[1])
    void** edx_19 = arg1[1]
    int32_t esi_5 = eax_6 * 0x38
    eax_6 = &edx_19[eax_6 * 0xe]
    
    if (arg2 != edx_19 && edx_19 != eax_6)
        int32_t var_40_8 = 0.d
        eax_6 = sub_474ca0(eax_6, edx_19, arg2, eax_6)
