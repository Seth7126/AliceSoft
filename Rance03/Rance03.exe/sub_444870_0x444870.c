...
do
    ...
    *ebx_11 += ((eax_9 + (edx_2 & 3)) s>> 2).w
    void* edi_3 = *(var_38 + 0xc) + (arg2 << 1)
    int32_t ecx_4 = *(arg4 + 0xc)
    ...
    *(ebx_17 + 0xc) += ((eax_82 + (edx_20 & 3)) s>> 2).w
    void* ebx_18 = *(var_38 + 0xc) + (arg2 << 1)
    void* edi_10 = *(arg4 + 0xc)
