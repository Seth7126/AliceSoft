...
int32_t (* var_a0)(void* arg1) = sub_74535e
TEB* fsbase
...
var_9c_1.b = 3
int16_t var_38
int16_t* ecx_7 = sub_62d2d0(&var_38, &var_20)
var_9c_1.b = 4
int16_t* edx_3
...
int32_t eax_8 = *(ecx_7 + 0x10)

if (*(ecx_7 + 0x14) u>= 8)
    ecx_7 = *ecx_7

int16_t* var_18_2 = ecx_7
int32_t var_1c_2 = 0x10
var_20.d = eax_6
int32_t* var_24 = ecx_7
ebx.b = sub_6330d0(eax_8, &edx_3[eax_8], ecx_7, var_24, var_20)
