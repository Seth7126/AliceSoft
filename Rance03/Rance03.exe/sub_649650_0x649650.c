...
int32_t eax
int80_t result
result, eax = sub_648e30(arg1, arg2, arg3)

if (eax s>= 0)
    int32_t eax_1 = sub_648030(arg1)
    ...
    if (eax_1 == 0)
        ...
        while (true)
            ...
            label_6497f4:
                ...
                int32_t eax_14
                int32_t edx_9
                eax_14, edx_9 = sub_647050(eax_1, &var_38, arg1, 0xffffffff, 0xffffffff)
                
                if (edx_9 s>= 0 && (edx_9 s> 0 || eax_14 u>= 0))
                    void* esi_6 = var_38
                    
                    if ((*(esi_6 + 5) & 2) != 0)
                        sub_638740(&arg1[0x78])
                        sub_638370(&arg1[0x94])
                        arg1[0x16] = 2
                    ...
                    if (arg1[0x16] s< 3)
                        ...
                        if (eax_1 == ecx_18)
                            ...
                            int32_t eax_21 = sub_648030(arg1)
                    ...
                    eax_1 = sub_63d2a0(ebx_1, &var_38)
                    continue
                
                esi_2 = arg2
            else
                void var_28
                eax_1 = sub_63d660(eax_1, &var_28, ebx_1, 0)
                ...
                if (eax_1 s<= 0)
                    ...
                    eax_1 = sub_646ef0((arg1[0x18] << 5) + esi_1, &var_28)
                    ...
                    if (eax_1 s< 0)
                        if (ebx_1 != 0)
                            if (*ebx_1 == 0)
                                ...
                                eax_1 = sub_63d660(eax_1, nullptr, ebx_1, 1)
                                continue
                    ...
                    if (edx_5 s> arg3)
                        ...
                        if (edx_5 s< arg3 || eax_11 u< esi_2)
                            if (ebx_1 != 0 && *ebx_1 != 0)
                                sub_63d660(eax_11, nullptr, ebx_1, 1)
                            
                            sub_646df0(&arg1[0x94], &var_28)
                            eax_1 = sub_638a50(&arg1[0x78], &arg1[0x94])
                            int32_t var_18
                            int32_t var_14
            ...
            if (temp2_1 s<= edx_19 && (temp2_1 s< edx_19 || arg1[0x14] u< eax_26))
                while (true)
                    ...
                    if (edx_25 s<= edx_22 && (edx_25 s< edx_22 || eax_37 u< eax_29)
                        ...
                        int32_t eax_39
                        int32_t edx_26
                        eax_39, edx_26 = sub_648940(arg1, 0xffffffff)
                        arg1[0x14] = eax_39
                        arg1[0x15] = edx_26
