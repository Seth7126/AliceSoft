...
int32_t (* var_c)(void* arg1) = sub_72e298
TEB* fsbase
...
if (ecx == 0)
    ...
    if (result == 0)
        ...
        if (result == 0)
            ...
            struct win32only::COpenFileDlg::VTable* const var_80_1 =
                &win32only::COpenFileDlg::`vftable'
            int32_t* eax_5 = sub_6e810c(0x764)
            int32_t* var_78_1 = eax_5
            int32_t* param0 = sub_6ce420(eax_5)
            ...
            if (eax_16 == eax_18)
                ...
                *(param0[0x1d8] + param0 + 0x35d) = 0
                eax_31 = GetOpenFileNameA(param0)
