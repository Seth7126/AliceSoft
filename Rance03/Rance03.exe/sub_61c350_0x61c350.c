...
int32_t __saved_edi
int32_t eax_5 =
    MultiByteToWideChar(0xfde9, 0, (**arg1)(0xffffffff, 0, 0, __security_cookie ^ &__saved_edi))
...
int32_t eax_9 = MultiByteToWideChar(0xfde9, 0, (**arg1)(0xffffffff, lpWideCharStr, eax_5))
int32_t cbMultiByte

if (eax_9 s> 0)
    lpWideCharStr[eax_5] = 0
    cbMultiByte =
        WideCharToMultiByte(0, 0, lpWideCharStr, 0xffffffff, nullptr, 0, &data_6ecc7c, nullptr)
