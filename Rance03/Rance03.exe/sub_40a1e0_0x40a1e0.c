...
struct dpanalysis::IToken::dpanalysis::CBinaryOperatorToken<&public: class dpanalysis::CTokenResult __thiscall dpanalysis::CTokenResult::Multiply(class dpanalysis::CTokenResult const &) const, 50>::VTable
    ** var_10_1 = arg1
*arg1 = &dpanalysis::CBinaryOperatorToken<&public: class dpanalysis::CTokenResult __thiscall dpanalysis::CTokenResult::Multiply(class dpanalysis::CTokenResult const &) const, 50>::`vftable'{for `dpanalysis::IToken'}
int32_t var_4 = 0
int32_t* ecx = arg1[1]
