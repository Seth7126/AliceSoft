...
do
    void* edi_1 = ecx + esi
    int16_t* eax_4 = *(ebx + 0x20) + ebp
    int32_t ecx_2 = *(arg6 + 0x20)
    ...
    int32_t eax_16
    int32_t edx_11
    edx_11:eax_16 = sx.q(sx.d(*(*(arg4 + 0x20) + ebp + eax_1)) + sx.d((eax_10 s>> 2).w) + 1)
    *eax_4 += ((eax_16 - edx_11) s>> 1).w
    int16_t* eax_22 = *(var_28 + 0x20) + 2 + arg7
    int32_t ecx_6 = *(arg6 + 0x20)
    ...
    int32_t eax_38
    int32_t edx_15
    edx_15:eax_38 = sx.q(sx.d(*(*(arg4 + 0x20) + eax_1 + arg7 + 2)) + 1 + sx.d((eax_31 s>> 2).w))
    *eax_22 += ((eax_38 - edx_15) s>> 1).w
    void* edx_18 = arg2 + 2 + esi
    int32_t ebp_4 = *(var_28 + 0x20)
    int32_t ecx_9 = *(arg6 + 0x20)
    ...
    *(arg7 + ebp_4 + 4) += ((eax_57 - edx_20) s>> 1).w
    ...
    int32_t edx_25
    edx_25:eax_76 =
        sx.q(sx.d(*(*(arg4 + 0x20) + arg7 + (arg5 << 1) + 6)) + 1 + sx.d((eax_69 s>> 2).w))
    ...
    *(arg7 + ebp_7 + 0xa) += ((eax_114 - edx_35) s>> 1).w
    ...
    int32_t edx_40
    edx_40:eax_133 =
        sx.q(sx.d(*(*(arg4 + 0x20) + arg7 + (arg5 << 1) + 0xc)) + 1 + sx.d((eax_126 s>> 2).w))
    *(arg7 + ebp_8 + 0xc) += ((eax_133 - edx_40) s>> 1).w
    ...
    int32_t edx_45
    edx_45:eax_152 =
        sx.q(sx.d(*(*(arg4 + 0x20) + arg7 + (arg5 << 1) + 0xe)) + 1 + sx.d((eax_145 s>> 2).w))
