...
double xmm1_1[0x2] = _mm_mul_pd(data_7145b0, xmm0)
double xmm2[0x2] = data_7145c0
double xmm1_2[0x2] = _mm_add_pd(xmm1_1, xmm2)
double xmm3_1[0x2] = data_7145d0
double xmm1_3[0x2] = _mm_sub_pd(xmm1_2, xmm2)
double xmm4[0x2] = data_7145e0
...
double xmm1_4[0x2] = __mulpd_xmmpd_mempd(xmm1_3, data_7145f0)
double xmm0_2[0x2] = _mm_sub_pd(xmm0_1, xmm4_1)
double xmm5_3 = __andpd_xmmxuq_memxuq(6.7164665968574641e-14 f* xmm1_3 f+ xmm0_1, data_714620)
...
double xmm7_1[0x2] = _mm_mul_pd(*(((ecx_1 * 5 + edx_2) << 4) + 0x712fc0), xmm0_3)
double xmm2_4 = _mm_sub_pd(xmm2_3, xmm1_4)
double xmm1_6[0x2] = _mm_mul_pd(*(((ecx_1 * 5 + edx_2) << 4) + 0x712fe0), xmm0_3)
double xmm4_3[0x2] = _mm_mul_pd(*(((ecx_1 * 5 + edx_2) << 4) + 0x713010), xmm0_3)
double xmm2_5[0x2] = xmm2_4 + xmm3_3 - xmm5_3
double xmm0_4[0x2] = _mm_mul_pd(xmm0_3, xmm0_3)
double xmm7_2[0x2] = __addpd_xmmpd_mempd(xmm7_1, *(0x712fb0 + ((ecx_1 * 5 + edx_2) << 4)))
double xmm1_8[0x2] =
    _mm_mul_pd(__addpd_xmmpd_mempd(xmm1_6, *(((ecx_1 * 5 + edx_2) << 4) + 0x712fd0)), xmm0_4)
double xmm4_4[0x2] = __addpd_xmmpd_mempd(xmm4_3, *(((ecx_1 * 5 + edx_2) << 4) + 0x713000))
double xmm7_3[0x2] = _mm_add_pd(xmm7_2, xmm1_8)
double xmm1_10[0x2] = _mm_mul_pd(*(((ecx_1 * 5 + edx_2) << 4) + 0x713020), xmm0_4)
double xmm0_5[0x2] = _mm_mul_pd(xmm0_4, xmm0_4)
double xmm4_5[0x2] = _mm_add_pd(xmm4_4, xmm1_10)
double xmm7_4[0x2] =
    _mm_add_pd(xmm7_3, _mm_mul_pd(*(((ecx_1 * 5 + edx_2) << 4) + 0x712ff0), xmm0_5))
double xmm3_6[0x2] = _mm_mul_pd(xmm0_3, xmm0_5)
double xmm1_14[0x2] = __mulpd_xmmpd_mempd(xmm0_3, *(((ecx_1 * 5 + edx_2) << 4) + 0x713040))
double xmm7_5[0x2] = _mm_add_pd(xmm7_4, _mm_mul_pd(xmm4_5, xmm3_6))
_mm_unpackhi_pd(xmm7_5, xmm7_5)
_mm_unpackhi_pd(xmm1_14, xmm1_14)
double xmm7_7 = *(((ecx_1 * 5 + edx_2) << 4) + 0x713040)
double xmm2_6 = _mm_unpackhi_pd(xmm2_5, xmm2_5)
(xmm7_7 + *(((ecx_1 * 5 + edx_2) << 4) + 0x713048)) * xmm2_6
    + *(((ecx_1 * 5 + edx_2) << 4) + 0x713038)
_mm_and_pd(zx.o(*(((ecx_1 * 5 + edx_2) << 4) + 0x713058)), 1.0 / xmm5_3)
    - *(((ecx_1 * 5 + edx_2) << 4) + 0x713030)
*(((ecx_1 * 5 + edx_2) << 4) + 0x713050)
return 0x712fb0 + ((ecx_1 * 5 + edx_2) << 4)
