...
int32_t (* var_c)(void* arg1) = sub_6b5a00
TEB* fsbase
...
if (arg2 != 0)
    if (arg2 u<= 0x3333333)
        eax_3 = sub_69adc6(arg2 * 0x50)
        edi = eax_3
        struct _EXCEPTION_REGISTRATION_RECORD** var_1c_1 = edi
    
    if (arg2 u> 0x3333333 || edi == 0)
        sub_69a4fc()
        noreturn

int32_t var_8_1 = 0
int32_t var_30_2 = arg2
sub_435c70(eax_3, arg1[1], *arg1, edi)
...
*esi_1 = edi
esi_1[2] = &edi[arg2 * 0x14]
void* result = &edi[((edx_2 u>> 0x1f) + edx_2) * 0x14]
esi_1[1] = result
fsbase->NtTib.ExceptionList = ExceptionList
return result
