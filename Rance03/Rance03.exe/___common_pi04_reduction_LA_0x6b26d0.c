...
if (arg3 u>= 0x40ff4000)
    ...
    if (esi_3 * 0xffffffe7 + ecx_3 - 0x41c s< 0x11)
        var_38_2 = data_75f550
    else
        long double x87_r6_8 = fconvert.t(*((esi_3 << 3) + &data_75f3a0))
        long double x87_r5_5 = fconvert.t(*((esi_3 << 3) + &data_75f3a8))
        esi_3 += 1
    ...
    long double x87_r6_14 = fconvert.t(*((esi_3 << 3) + &data_75f3a8))
    var_60_1.t = x87_r6_14 * x87_r7_11 + 0 * fconvert.t(*((esi_3 << 3) + &data_75f3b0))
    long double x87_r7_15 =
        fconvert.t(*((esi_3 << 3) + &data_75f3a0)) * x87_r7_11 + 0 * x87_r6_14 + var_38_2
    ...
    long double x87_r3_5 = fconvert.t(*((esi_3 << 3) + &data_75f3b8))
    var_40_1.d = eax_4
    var_40_1:4.d = edx_9
    long double x87_r2_8 = fconvert.t(*((esi_3 << 3) + &data_75f3c0))
    long double x87_r3_8 = fconvert.t(*((esi_3 << 3) + &data_75f3c8))
    long double x87_r6_24 = var_60_1.t + x87_r7_15 - fconvert.t(var_40_1) + x87_r3_5 * 0
        + fconvert.t(*((esi_3 << 3) + &data_75f3b0)) * x87_r7_11 + x87_r3_5 * x87_r7_11
        + 0 * x87_r2_8 + x87_r2_8 * x87_r7_11 + 0 * x87_r3_8
    long double x87_r2_13 = fconvert.t(*((esi_3 << 3) + &data_75f3d0))
    long double x87_r6_26 = data_75f5a0
    x87_r7_8 = x87_r6_26
    var_38_1 = (0 * fconvert.t(*((esi_3 << 3) + &data_75f3d8)) + x87_r7_11 * x87_r2_13 + x87_r6_24
        + x87_r3_8 * x87_r7_11 + 0 * x87_r2_13) * x87_r6_26
else
    long double x87_r7_2 = data_75f5b0 * x87_r7
    int16_t x87status_2
    int16_t temp0_2
