...
void* eax = sub_638110(ebp_1, *(esi + 0xc))
...
if (eax s> 0)
    ...
    void* eax_3 = sub_638110(ebp_1, edx_1)
    ...
    if (eax_3 != 0xffffffff && eax_3 s< *(esi + 0x14))
        ...
        int32_t result = sub_6382a0(ecx_3, ((*(arg2 i+ 4) + *ebx_1) << 2) + 4)
        
        if (sub_639a80(result, result, ebx_1, ebp_1, *(arg2 i+ 4)) != 0xffffffff)
