...
sub_4fbef0(&var_c4, eax_4, ecx_1, esi_1)
arg5 - 1f
int32_t* eax
...
label_4ff89d:
    ...
    if (var_b8 s> 0 && var_b4 s> 0)
        ...
        float xmm3_2 = _mm_cvtepi32_ps(zx.o(var_b8))
        float xmm1_2 = _mm_cvtepi32_ps(zx.o(var_b4))
        int32_t var_bc
        float xmm4_2 = _mm_cvtepi32_ps(zx.o(var_bc))
        float xmm3_3 = xmm3_2 + xmm0_14
        float var_a0 = xmm0_14
        var_cc = xmm0_14
        float xmm0_16 = xmm1_2 + xmm4_2
        float var_9c_1 = xmm4_2
        float var_8c_1 = xmm4_2
        float var_90 = xmm3_3
        var_d4 = xmm3_3
        ...
        arg8 f- 0
        int32_t* eax_9
        eax_9:1.b = (arg8 == 0f ? 1 : 0) << 6 | (is_unordered.d(arg8, 0f) ? 1 : 0) << 2
            | (arg8 < 0f ? 1 : 0)
        ...
        if (p_12)
            void* ecx_8 = &var_88
            EnumC13Lines::EnumC13Lines(ecx_8)
            sub_47b7f0(ecx_8, 0x80000000 ^ arg8)
            sub_47b440(&var_48, &var_88)
        
        arg7 f- 0
        eax_9:1.b = (arg7 == 0f ? 1 : 0) << 6 | (is_unordered.d(arg7, 0f) ? 1 : 0) << 2
            | (arg7 < 0f ? 1 : 0)
        ...
        if (p_14)
            ...
            sub_47b8b0(ecx_10, 0x80000000 ^ arg7)
            sub_47b440(&var_48, &var_88)
        
        arg9 f- 0
        eax_9:1.b = (arg9 == 0f ? 1 : 0) << 6 | (is_unordered.d(arg9, 0f) ? 1 : 0) << 2
            | (arg9 < 0f ? 1 : 0)
        ...
        if (p_16)
            ...
            sub_47b960(ecx_12, arg9 ^ (data_7094c0).d)
            sub_47b440(&var_48, &var_88)
        
        var_dc = &partsengine::COriginPosMode::`vftable'
        int32_t* var_d8_2 = arg4
        int32_t eax_10 = sub_50feb0(&var_dc, var_b8)
        var_dc = &partsengine::COriginPosMode::`vftable'
        int32_t* var_d8_3 = arg4
        float xmm1_8 = _mm_cvtepi32_ps(zx.o(eax_10))
        uint128_t xmm0_21 = zx.o(sub_50ff00(&var_dc, var_b4))
        float xmm2_3 = _mm_cvtepi32_ps(zx.o(var_b8))
        float var_a8 = xmm1_8
        float xmm2_4 = xmm2_3 + xmm1_8
        float var_b0 = xmm1_8
        float xmm0_22 = _mm_cvtepi32_ps(xmm0_21)
        float xmm1_10 = _mm_cvtepi32_ps(zx.o(var_b4))
        float var_98 = xmm2_4
        float xmm1_11 = xmm1_10 + xmm0_22
        var_dc = xmm2_4
        float var_a4_1 = xmm0_22
        float var_94_1 = xmm0_22
        float var_ac_1 = xmm1_11
        float var_d8_4 = xmm1_11
        sub_506850(edi_1, arg2, arg3, &var_48, &var_a8, &var_98, &var_b0, &var_dc, &var_a0, 
            &var_90, &var_cc, &var_d4, arg10)
else
    arg6 - 1f
    eax:1.b =
    ...
    if (sub_4a1f10(ecx_2).b != 0)
        goto label_4ff89d
    
    int32_t ecx_3 = int.d(fconvert.t(arg8))
    float xmm0_4 = _mm_cvtepi32_ps(zx.o(ecx_3))
    xmm0_4 - arg8
    eax:1.b = (xmm0_4 == arg8 ? 1 : 0) << 6 | (is_unordered.d(xmm0_4, arg8) ? 1 : 0) << 2
        | (xmm0_4 < arg8 ? 1 : 0)
    ...
    if (sub_4a1f10(ecx_3).b != 0)
        goto label_4ff89d
    
    int32_t ecx_4 = int.d(fconvert.t(arg9))
    float xmm0_6 = _mm_cvtepi32_ps(zx.o(ecx_4))
    xmm0_6 - arg9
    eax:1.b = (xmm0_6 == arg9 ? 1 : 0) << 6 | (is_unordered.d(xmm0_6, arg9) ? 1 : 0) << 2
        | (xmm0_6 < arg9 ? 1 : 0)
