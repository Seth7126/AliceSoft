...
int32_t (* var_c)(void* arg1) = sub_749979
TEB* fsbase
...
void* const var_dc_5 = &data_6db75b
...
if (arg4 == 0)
    int32_t var_8_1 = 2
    int32_t var_c0
    int32_t* eax_5 = sub_6d6f91(std::ios_base::getloc(arg5, &var_c0))
    esi_1 = eax_5
    var_6c = eax_5
    ecx_2 = &var_c0
else
    int32_t var_8 = 1
    void var_b8
    esi_1 = sub_6d6ef4(std::ios_base::getloc(arg5, &var_b8))
    ecx_2 = &var_b8
    var_6c = esi_1
...
var_8_2.b = 4
int32_t var_c8
int32_t* eax_9 = sub_6d6aa9(std::ios_base::getloc(ebx_2, &var_c8))
var_8_2.b = 3
std::_Debug_range2<class std::move_iterator<class std::_Vector_iterator<class std::_Vector_val<struct std::_Simple_types<class std::shared_ptr<struct Concurrency::details::_Task_impl<struct std::pair<uint8_t,class Concurrency::details::_CancellationTokenState*> > > > > > > >(
    &var_c8)
int32_t esi_4 = *(*eax_9 + 0x2c)
j_sub_4033e0()
                ...
                if (ebx_9.b == 0)
                    ...
                    if (ebx_10.b == 0)
                        ...
                        std::istreambuf_iterator<uint16_t,struct std::char_traits<uint16_t> >::_Inc(
                            edi_1)
                        sub_6d79dd(&var_5c, sub_6e6a81(var_6c, &var_44))
                        std::basic_string<wchar_t,struct std::char_traits<wchar_t>,class std::allocator<wchar_t> >::_Tidy(
                            &var_44, 1, nullptr)
                        var_65 = 1
                        ebx_2 = arg5
                    ...
                    std::istreambuf_iterator<uint16_t,struct std::char_traits<uint16_t> >::_Inc(
                        edi_1)
                    sub_6d79dd(&var_5c, sub_6e3618(var_6c, &var_44))
                    ecx_63 = &var_44
                label_6dbd8e:
                    std::basic_string<wchar_t,struct std::char_traits<wchar_t>,class std::allocator<wchar_t> >::_Tidy(
                        ecx_63, 1, nullptr)
...
fsbase->NtTib.ExceptionList = ExceptionList
void* const __saved_ebp_1 = &data_6dc0c4
return arg1
