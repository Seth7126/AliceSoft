...
if (arg5 != 0)
    ...
    int32_t var_c_1 = 0
    void* esi_1 = sub_4612f0(arg1 + 8, &var_64)
    ...
    int32_t var_54_1 = 0
    var_64 = 0
    int32_t eax_6 = sub_457ae0(esi_1 + 0x2c, arg3)
    int32_t var_4c
    sub_401f60(&var_4c, arg4)
    int32_t var_c_3 = 1
    int32_t eax_7 = sub_45eea0(esi_1 + 0x30, &var_4c)
    ...
    int32_t var_34
    char* ecx_7 = sub_4609d0(esi_1, &var_34, eax_6, eax_7)
    int32_t var_c_5 = 2
