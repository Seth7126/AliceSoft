...
if (((0x3f5db3d7 - (0x7fffffff & arg1)) | (edx - 0x3d800000)) s>= 0)
    ...
    *((edx_3 << 1) + &data_79f800)
    int128_t xmm4 = *((edx_3 << 2) + &data_79b400)
...
if (((0x1feffff - (edx - 0x3d800000)) | (edx - 0x3d800000)) s>= 0)
    ...
    float xmm1_3 = __andps_xmmxud_memxud(xmm1_2, data_79bc00)
    float xmm7_5 = __andps_xmmxud_memxud(xmm1_2, data_79bc10)
    ...
    float xmm3_5 = xmm3_4 f* *((edx_6 << 1) + &data_79f800)
    ...
    float xmm7_8[0x4] = _mm_sub_ps(data_79bc30, *((edx_6 << 2) + &data_79b400))
...
float xmm7_10 = __andps_xmmxud_memxud(xmm7_9, data_79bc20)
float xmm5_10 = _mm_shuffle_epi32(xmm3_13, 0)
float xmm3_14 = __andps_xmmxud_memxud(xmm3_13, data_79bc20)
...
uint32_t xmm0_23[0x4] = data_79bc30
