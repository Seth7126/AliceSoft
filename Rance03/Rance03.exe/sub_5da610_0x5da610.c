...
int32_t (* var_8)(void* arg1) = sub_6ca780
TEB* fsbase
...
if (sub_5daca0(arg5, arg1, arg2, &var_74, 1) != 0)
    ...
    if (sub_5d7a10(&var_74, &var_5c) == 0)
        ebx.b = 0
    else if (sub_40c250(&var_5c, 0x6ea96c) == 0)
        ebx.b = 0
        ...
        if (sub_5d7a10(&var_74, &var_2c) == 0)
            ...
            if (edi_1 s<= 0)
            label_5da7d9:
                int32_t eax_15 = var_68 - var_60
                
                if (eax_15 s> 0)
                    if (sub_64aeb0(arg4, eax_15) == 0)
                        ebx.b = 0
                        sub_401fb0(&var_2c)
                    else
                        void* eax_17 = *(arg4 + 8)
                        ...
                        if (eax_17 != 0)
                            eax_18 = sub_5d7910(&var_74, ecx_12, eax_17)
