...
for (int32_t i = eax_8 s>> 1; i s>= 1; i -= 1)
    eax_8 = sub_6a2680(eax_8, ebx, arg1, i)
...
do
    ...
    *(arg1 + (*(arg1 + 0x1454) << 2) + 0xb5c) = ecx_4
    int32_t eax_12
    eax_12.w = *edx_4
    eax_12.w += *(ebx + (edi_2 << 2))
    *(ebx + (ebp_1 << 2)) = eax_12.w
    eax_12.b = *(arg1 + edi_2 + 0x1458)
    ...
    *(arg1 + ebp_1 + 0x1458) = eax_13 + 1
    ...
    edx_4[1] = eax_14.w
    *(ebx + (edi_2 << 2) + 2) = eax_14.w
    *(arg1 + 0xb60) = ebp_1
    ebp_1 += 1
    sub_6a2680(eax_14, ebx, arg1, 1)
while (*(arg1 + 0x1450) s>= 2)

*(arg1 + 0x1454) -= 1
*(arg1 + (*(arg1 + 0x1454) << 2) + 0xb5c) = *(arg1 + 0xb60)
return sub_6a2980(sub_6a2750(arg1, arg2), var_c, ebx, arg1 + 0xb3c)
