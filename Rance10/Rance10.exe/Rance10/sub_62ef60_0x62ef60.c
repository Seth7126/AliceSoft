...
int32_t (* var_88)(void* arg1) = sub_7453e6
TEB* fsbase
...
var_20.d = eax_10
char eax_11 = sub_6331a0(eax_10, eax_8, &var_d8, ecx_8, var_20)
char* ecx_10 = var_1c
bool var_91 = eax_11 == 0

if (ecx_10 != 0)
    bool cond:2_1 = *(ecx_10 + 0x20) != 1
    *(ecx_10 + 0x20)
    *(ecx_10 + 0x20) -= 1
...
if (var_3c u>= 8)
    ...
    var_1c = var_3c + 1
    var_20.d = var_50
    sub_403160(var_20, var_1c, var_18_4)
...
if (var_91 == 0)
    ...
    for (; i != edi_3; i = &i[3])
        ...
        if (var_c u>= 0x10)
            ...
            var_1c = var_c + 1
            var_20.d = var_20.d
            sub_403160(var_20, var_1c, var_18_10)
    ...
    (*(*arg2 + 0x48))()
    int32_t esi_2 = var_d0.d
    
    if (esi_2 != 0)
        int32_t var_18_5 = 0xc
        var_1c = (var_d0:8.d - esi_2) s/ 0xc
        var_20.d = esi_2
