...
struct dpanalysis::IToken::dpanalysis::CUnaryOperatorToken<&public: class dpanalysis::CTokenResult __thiscall dpanalysis::CTokenResult::LogicalNot(void) const, 30>::VTable
    ** var_10_1 = arg1
*arg1 = &dpanalysis::CUnaryOperatorToken<&public: class dpanalysis::CTokenResult __thiscall dpanalysis::CTokenResult::LogicalNot(void) const, 30>::`vftable'{for `dpanalysis::IToken'}
int32_t var_4 = 0
int32_t* ecx = arg1[1]
