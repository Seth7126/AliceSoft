...
if (eax_3 == 0)
    int32_t* eax_6 = sub_5cd2e0(ecx_1, &var_38, var_5c_1)
    var_20 = nullptr
    ...
    int32_t* eax_4 = sub_5cd140(ecx_1, &var_40, var_5c_1)
    var_30 = nullptr
    __builtin_memset(&var_2c, 0, 4)
    sub_4323a0(&var_30, eax_4)
    eax_5 = &var_30
    ebx = 3
...
if (ebx.b != 0)
    struct common::NotifyRefCounter<class ISurface>::sealengine::CResourceSurface::VTable** 
        eax_11 = sub_6e810c(0x2c)
    var_1c = eax_11
    var_8_1.b = 0xa
    int32_t* var_48
    int32_t* eax_13 = sub_432270(&var_48, sub_5d44b0(eax_11, &var_28, arg1[2], *arg1 + 0x94))
    result = arg2
    *result = 0
    result[1] = 0
    sub_4323a0(result, eax_13)
    SRWLOCK var_44
