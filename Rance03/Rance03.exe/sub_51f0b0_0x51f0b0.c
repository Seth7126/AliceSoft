...
int32_t var_64
int32_t* eax_7 =
    sub_410930(sub_410930(&ExceptionList, arg4, &var_7c, ."), &var_7c, &var_64, 0x6e3114)
int32_t* edi = eax_7
var_c_1.b = 1
char var_94
int32_t* eax_8 = sub_410930(eax_7, &var_7c, &var_94, 0x6e3128)
var_c_1.b = 2
char var_34
int32_t* eax_9 = sub_410930(eax_8, &var_7c, &var_34, 0x6e30d4)
var_c_1.b = 3
char var_4c
int32_t* eax_10 = sub_410930(eax_9, &var_7c, &var_4c, 0x6e30e8)
var_c_1.b = 4
...
var_c_1.b = 6
int32_t* result =
    sub_504240(arg1, sub_401c90(arg3, &var_94, sub_410930(eax_17, &var_7c, &var_64, 0x6e30fc)))
void** ebx
ebx.b = result.b == 0
...
if (ebx.b == 0)
    int32_t* eax_21 = sub_410930(result, &var_7c, &var_64, 0x6e3104)
    ebx = eax_21
    var_c_1.b = 7
    int32_t* edi_2 = sub_410930(eax_21, &var_7c, &var_94, 0x6e30cc)
    result = result_1
