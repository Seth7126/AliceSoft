...
if (ecx == 0)
    ...
    int32_t eax_10 = *(arg2 + 0x54)
    int32_t var_68_1 = eax_10
    int32_t var_6c_1 = edi_1
    int32_t* var_70_1 = var_48_1
    int32_t var_74_1 = var_4c_1
    
    if (sub_5504e0(arg1, var_50).b != 0)
        result.b = 1
    else
        void* var_44
        sub_403360(&var_44, 0x7644c0)
        int32_t var_8_1 = 0
        var_8_1.b = 1
        char var_2c
        sub_45aae0(sub_4cb680(&var_50, &var_44, &var_2c, &var_50, var_4c_1, var_48_1, edi_1, 
            eax_10))
        int32_t var_18
