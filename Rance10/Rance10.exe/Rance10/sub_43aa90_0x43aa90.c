...
do
    ...
    *(arg5 + ebp_6 + 6) += ((eax_42 + (edx_17 & 3)) s>> 2).w
    ...
    int32_t ebp_7 = *(result_1 + 8)
    int32_t ecx_8 = *(arg4 + 8)
    ...
    *(arg5 + ebp_7 + 8) += ((eax_54 + (edx_22 & 3)) s>> 2).w
    ...
    int32_t ebp_8 = *(result_1 + 8)
    int32_t ecx_10 = *(arg4 + 8)
    ...
    *(arg5 + ebp_8 + 0xa) += ((eax_66 + (edx_27 & 3)) s>> 2).w
    ...
    int32_t ebp_9 = *(result_1 + 8)
    int32_t ecx_12 = *(arg4 + 8)
