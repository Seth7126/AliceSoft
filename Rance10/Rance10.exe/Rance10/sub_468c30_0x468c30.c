...
int32_t (* var_c)(void* arg1) = sub_72cbb8
TEB* fsbase
...
if (*(eax_12 + 0x30) == 0x12)
    *(arg2 + 0x34) = 3
    ...
    if (*(arg3 + 0x20) == 0 || eax_13 == *(arg3 + 0x1c))
        sub_46df20(arg2, nullptr)
        result.b = 1
    else
        sub_46df20(arg2, eax_13 + 8)
        result.b = 1
else
    void* var_30
    ...
    label_469126:
        ...
        if (sub_467380(&var_60, arg3) != 0)
            ...
            if (eax_26 != 0x11)
                ...
                label_4690ec:
                    ...
                    if (sub_471ff0(arg3) == 0)
                        sub_403360(ecx_22, 0x75f49c)
                        var_8_1.b = 7
                        goto label_4690ec
                    
                    sub_403360(ecx_22, 0x75f4b8)
                    var_8_1.b = 6
                ...
                if (*(arg3 + 0x20) == 0)
                    ...
                    *(arg3 + 0x24) = eax_30
                    ...
                    ebx_2.b = sub_407560(sub_471e40(sub_471ff0(arg3), &var_48), 0x75f468)
                    sub_403320(&var_48)
            ...
            if (*(arg3 + 0x20) == 0 || *(arg3 + 0x24) == *(arg3 + 0x1c))
                *(arg3 + 0x24) = *(*(arg3 + 0x24) + 4)
                sub_403360(&var_30, 0x75f328)
                var_8_1.b = 2
            else
                sub_403360(&var_30, 0x75f2f8)
                var_8_1.b = 3
