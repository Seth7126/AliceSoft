...
if ((arg2 & 0x1000000) == 0)
    if ((arg2 & 0x800000) == 0)
        ...
        *arg1 = neg.d(sbb.d(edx_16, edx_16, edx_15 != 0)) + 0x17
        return 0xa
    
    void* edx_10 = arg2 & &__dos_header
    int32_t edx_11 = neg.d(edx_10)
    *arg1 = neg.d(sbb.d(edx_11, edx_11, edx_10 != 0)) + 0x19
    return 0xa

if ((arg2 & 0x800000) == 0)
    void* edx_5 = arg2 & &__dos_header
    int32_t edx_6 = neg.d(edx_5)
    *arg1 = neg.d(sbb.d(edx_6, edx_6, edx_5 != 0)) + 0x1b
    return 0xa

void* edx = arg2 & &__dos_header
int32_t edx_1 = neg.d(edx)
*arg1 = neg.d(sbb.d(edx_1, edx_1, edx != 0)) + 0x1d
return 0xa
