            ...
            if (esi_2 s>= edx_1 && *(eax_12 + 4) + edx_1 s> esi_2)
                ...
                if (esi_4 != 0)
                    ...
                    if (*(esi_4 + 0xaa) == 0 || *(esi_4 + 0xab) == 0 || edx_2 == 0 || eax_14 == 0)
                        ...
                        float ecx_9 = var_8
                        int32_t edx_4 = var_c + *(esi_4 + 0x118) + *(esi_4 + 0x114)
                        int32_t xmm2_1 = var_1c
                        var_c = edx_4
                        float ecx_10 = ecx_9 i+ *(esi_4 + 0x110) + *(esi_4 + 0x10c)
                        ...
                        if (cond:2_1)
                            ...
                            if (not(_mm_cvtepi32_ps(zx.o(ecx_10)) f+ xmm2_1
                                ...
                                var_14 = xmm1_3 f+ var_14
                                xmm1_3 = (zx.o(0)).d
                                var_10 = __maxss_xmmss_memss(xmm2_1, var_10)
                                xmm2_1 = (zx.o(0)).d
...
float xmm2_3 = __maxss_xmmss_memss(xmm2, var_10)
*arg2 = _mm_cvtepi32_ps(zx.o(eax_21)) + xmm1 f+ var_14
*arg3 = _mm_cvtepi32_ps(zx.o(*(arg1 + 0x5c) + *(arg1 + 0x58))) + xmm2_3
return arg3
