...
void* var_58_1 = eax_1
std::_Mpunct<char,char>::_Getvals<char>(arg1, nullptr)
char eax_4
...
std::_Mpunct<char>::_Makpat(arg1, arg1 + 0x20, sx.d(*(eax_1 + 0x2b)), sx.d(*(eax_1 + 0x2a)), 
    sx.d(*(eax_1 + 0x2e)))
int32_t result = std::_Mpunct<char>::_Makpat(arg1, arg1 + 0x24, sx.d(*(eax_1 + 0x2d)), 
...
fsbase->NtTib.ExceptionList = ExceptionList
void* const __saved_ebp_1 = &data_6e4f89
return result
