...
do
    ...
    int16_t* edi_1 = *(arg6 + 8) + ((ecx_7 + esi) << 1)
    ...
    *ebp_1 += ((eax_14 - edx_6) s>> 1).w
    ...
    int32_t edx_7 = *(arg4 + 8)
    int16_t* edi_2 = *(arg6 + 8) + ((arg2 + 1 + esi) << 1)
    ...
    *(ebp_3 + 2) += ((eax_35 - edx_10) s>> 1).w
    ...
    int16_t* edi_3 = *(arg6 + 8) + ((arg2 + 2 + esi) << 1)
    ...
    *(arg7 + ebp_4 + 4) += ((eax_56 - edx_14) s>> 1).w
    ...
    int16_t* edi_4 = *(arg6 + 8) + ((arg2 + 3 + esi) << 1)
    ...
    *(arg7 + ebp_5 + 6) += ((eax_77 - edx_18) s>> 1).w
    ...
    int32_t edx_19 = *(arg4 + 8)
    int16_t* edi_5 = *(arg6 + 8) + ((arg2 + 4 + esi) << 1)
    ...
    *(arg7 + ebp_6 + 8) += ((eax_98 - edx_22) s>> 1).w
    ...
    int32_t edx_23 = *(arg4 + 8)
    int16_t* edi_6 = *(arg6 + 8) + ((arg2 + 5 + esi) << 1)
    ...
    *(arg7 + ebp_7 + 0xa) += ((eax_119 - edx_26) s>> 1).w
    ...
    int32_t edx_27 = *(arg4 + 8)
    int16_t* edi_7 = *(arg6 + 8) + ((arg2 + 6 + esi) << 1)
    ...
    *(arg7 + ebp_8 + 0xc) += ((eax_140 - edx_30) s>> 1).w
    ...
    int32_t edx_31 = *(arg4 + 8)
    int16_t* edi_8 = *(arg6 + 8) + ((arg2 + 7 + esi) << 1)
