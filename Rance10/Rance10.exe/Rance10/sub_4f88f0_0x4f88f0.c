...
if (*(arg1 + 0xe0) != 0)
    ...
    if (*(arg1 + 0x110) != 0)
        ...
        int32_t var_20_1 = 0
        var_30 = 0
        sub_403590(&var_30, arg1 + 0x100, 0, 0xffffffff)
        eax_5 = &var_30
        int32_t var_8_3 = 2
        ebx_1 = 8
    else
        int32_t* eax_4 = sub_4175e0(arg1 + 0x100, arg1 + 0xd0, &var_60, 0x765638)
        int32_t var_8_1 = 0
        int32_t var_64_1 = 2
        eax_5 = sub_417750(eax_4, eax_4, &var_48, arg1 + 0x1c)
        int32_t var_8_2 = 1
        ebx_1 = 6
