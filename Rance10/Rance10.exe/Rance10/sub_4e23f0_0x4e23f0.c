...
int32_t* eax_5 = *(arg1 + 0x210)
void* eax_7 = *(*(arg1 + 0x220) + 8)

if (eax_7 != 0 && sub_4d62f0(eax_7, arg1 + 0x1b4) != 0)
    void* esi_1 = *(sub_4efcc0(*(arg1 + 0xa0)) + 0x44)
    sub_555e00(esi_1, 0x1a, 3)
    int32_t eax_10 = sub_4dbf90(*(esi_1 + 0x88), arg1 + 0x1b4)
    fsbase->NtTib.ExceptionList = ExceptionList
    return eax_10
...
if (sub_44c4e0(eax_11) != 0)
    int32_t* eax_14 = sub_4e2050(arg1, arg1 + 0x13c, arg1 + 0x1e4, arg1 + 0xc0, 3)
    fsbase->NtTib.ExceptionList = ExceptionList
    return eax_14
...
if (eax_15 == 0)
    ...
    char var_34_2 = 1
    int32_t (__stdcall* var_30_2)(void* arg1, int32_t arg2, int32_t arg3, int32_t arg4) = sub_5192b0
    eax_15 = &var_38

int32_t eax_20 = sub_4e1f20(arg1, arg1 + 0x1e4, eax_3, eax_4, arg1 + 0xc0, 1, eax_15, 3)
fsbase->NtTib.ExceptionList = ExceptionList
return eax_20
