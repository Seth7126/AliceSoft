...
int32_t (* var_8)(void* arg1) = sub_6bd0b0
TEB* fsbase
...
int32_t* var_24
int32_t* result_1
sub_4e3640(arg1 + 0x24, &result_1, &var_24, &var_30, &var_3c)
