...
if (not(arg3 <= 0f))
    ...
    do
        ...
        int32_t ecx_2 = int.d(xmm1 f+ arg1)
        float xmm1_3 = _mm_cvtepi32_ps(zx.o(int.d(xmm1 * xmm3_2 + 0.5f)))
        int32_t var_c4_1 = ecx_2
        int32_t var_bc_1 = ecx_2
        int32_t var_c0_1 = int.d(xmm1_3 + xmm2_1 + var_ec)
        int32_t var_b8_1 = int.d(xmm2_1 - xmm1_3 + var_ec)
