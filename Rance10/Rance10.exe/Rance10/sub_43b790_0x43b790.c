...
do
    ...
    *ebp_2 += ((eax_5 + (edx_2 & 3)) s>> 2).w
    ...
    void* ebp_4 = arg5 + *(result_1 + 0x14)
    int32_t ecx_3 = *(arg4 + 0x14)
    ...
    *(ebp_4 + 2) += ((eax_18 + (edx_7 & 3)) s>> 2).w
    ...
    int32_t ebp_5 = *(result_1 + 0x14)
    int32_t ecx_4 = *(arg4 + 0x14)
    ...
    *(arg5 + ebp_6 + 6) += ((eax_42 + (edx_17 & 3)) s>> 2).w
    ...
    int32_t ebp_7 = *(result_1 + 0x14)
    int32_t ecx_8 = *(arg4 + 0x14)
    ...
    *(arg5 + ebp_7 + 8) += ((eax_54 + (edx_22 & 3)) s>> 2).w
    ...
    int32_t ebp_8 = *(result_1 + 0x14)
    int32_t ecx_10 = *(arg4 + 0x14)
    ...
    *(arg5 + ebp_8 + 0xa) += ((eax_66 + (edx_27 & 3)) s>> 2).w
    ...
    int32_t ebp_9 = *(result_1 + 0x14)
    int32_t ecx_12 = *(arg4 + 0x14)
