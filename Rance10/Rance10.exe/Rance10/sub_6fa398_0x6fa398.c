    ...
    if (eax_2 != arg2)
        ...
        if (arg4 != 0)
            if (zx.d(QueryDepthSList(arg1)) s<= arg1->__offset(0x44).d)
                InterlockedPushEntrySList(arg1, arg2 + 0x120)
            else
                InterlockedPushEntrySList(&arg1[1], arg2 + 0x120)
                ...
                if (zx.d(QueryDepthSList(&arg1[1])) s> arg1->__offset(0x44).d &&
                    ...
                    if (Alignment == 0)
                        ...
                        sub_6f1a81(arg1 + 0x14, 
                            Concurrency::details::ListArray<class Concurrency::details::WorkQueue>::CheckForDeletionBridge, 
                            arg1, var_1c_5)
