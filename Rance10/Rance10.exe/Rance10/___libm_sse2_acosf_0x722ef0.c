...
if ((0x7fffffff & arg1) - 0x3d800000 u< 0x1ddb3d7)
    ...
    *((edx_3 << 1) + &data_79f800)
    int128_t xmm4 = *((edx_3 << 2) + &data_79abd0)
    _mm_or_ps(_mm_and_ps(xmm2, xmm1), xmm7)
    _mm_shuffle_epi32(xmm1, 0)
    _mm_shuffle_epi32(xmm1, 0)
    int32_t eax = arg1 & 0x80000000
    float xmm1_3[0x4] = _mm_sub_ps(data_79b3d0, xmm4 ^ _mm_shuffle_epi32(zx.o(eax), 0))
...
if ((0x7fffffff & arg1) - 0x3f5db3d7 u< 0x204c29)
    ...
    *((edx_7 << 1) + &data_79f800)
    _mm_shuffle_epi32(
        _mm_add_ps(__andps_xmmxud_memxud(xmm7_11, data_79b3e0), *((edx_7 << 2) + &data_79abd0)), 
        0x55)
...
if ((0x7fffffff & arg1) - 0x3f7e0000 u< 0x20000)
    ...
    uint32_t xmm0_19[0x4] = __andps_xmmxud_memxud(_mm_shuffle_epi32(zx.o(eax_10), 0), data_79b3f0)
