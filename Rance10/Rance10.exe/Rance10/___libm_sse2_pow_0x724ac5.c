    ...
    if (ecx_7 u< 0x7ff00000)
        ...
        label_724f5a:
            ...
            label_724f80:
                ...
                xmm4 = xmm0.q
                xmm0 = _mm_srli_epi64(__andpd_xmmxuq_memxuq(xmm0, data_79e660), 0x2c)
                int32_t eax_38 = (zx.d(_mm_extract_epi16(xmm0, 0)) + 1) & 0x1fe
                xmm7_2 = _mm_or_pd(xmm7_15, xmm2_25) f* *((eax_38 << 2) + &data_758698)
                xmm5 = *((eax_38 << 2) + &data_758698)
                xmm6 = *(eax_38 * 8 + &data_758ab0)
                edx_1 = 0x43e7f
                goto label_724b58
        else
            ...
            if (edx_10 u>= 0x7ff0)
                ...
                if ((eax_29 & 0xff) == 0xff)
                    eax_44 = zx.d(_mm_movemask_epi8(_mm_cmpeq_epi32(
                        _mm_sll_epi64(arg2, 
                            _mm_sub_epi32(
                                _mm_srli_epi64(__andpd_xmmxuq_memxuq(arg2, data_79e660), 0x34), 
                                0x3f4)), 
                        zx.o(0))))
...
label_724b58:
    ...
    uint64_t xmm4_1[0x2] = __andpd_xmmxuq_memxuq(xmm4, data_79e640)
    ...
    uint64_t xmm4_2[0x2] = __orpd_xmmxuq_memxuq(xmm4_1, data_79e650)
    ...
    if (eax_15 u< 0x7ff0)
        ...
        if (((0x40a0 - eax_17) | (eax_17 - 0x3c70)) u< 0x80000000
            ...
            if (((0x1ff7f - eax_19) | (eax_19 + 0x1e1ff)) s> 0)
                ...
                double xmm3_9[0x2] = *(eax_26 + 0x75b720)
                double xmm6_8[0x2] = data_79e670
                ...
                double xmm7_10[0x2] = data_79e680
            ...
            label_725328:
                ...
                double xmm3_19[0x2] = *((eax_21 & 0x7f) * 0x10 + 0x75b720)
                double xmm6_12[0x2] = data_79e670
                ...
                double xmm7_20[0x2] = data_79e680
