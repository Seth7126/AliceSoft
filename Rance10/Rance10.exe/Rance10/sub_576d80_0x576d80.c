...
char* result
int32_t ecx
result, ecx = sub_576cf0(arg3, eax)
int32_t esi_2 = 0x20
...
if (arg4 s> 0x20)
    do
        ...
        int32_t eax_3 = sub_577670(eax_2, var_4, ebp, 0, 0, 0, nullptr)
        int32_t** ecx_3 = *(arg5 + 0x10)
        int32_t esi_3 = esi_2 * 2
        result, ecx = sub_5777d0(eax_3, ecx_3[1], *ecx_3, ebp, esi_3, arg4)
        esi_2 = esi_3 * 2
    while (esi_2 s< arg4)
