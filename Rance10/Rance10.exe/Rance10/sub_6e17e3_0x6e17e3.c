...
void* const var_30_5 = &data_6e17ef
...
if (temp1 == 0)
    ...
    int32_t esi_1 = *(eax_1->vFunc_0 + 0x38)
    j_sub_4033e0()
...
if (temp1 != 0 || eax_4 != 0x3a)
    *arg5 |= 2
    ...
    struct std::ctype_base::std::ctype<wchar_t>::VTable* var_30_3 = eax_1
...
if (*arg5 != 0)
    *arg5 |= 2
    ...
    int32_t esi_2 = *(eax_1->vFunc_0 + 0x38)
    j_sub_4033e0()
    ...
    if (esi_2(var_34_3, 0) != 0x3a)
        *arg5 |= 2
        ...
        std::istreambuf_iterator<uint16_t,struct std::char_traits<uint16_t> >::_Inc(&arg_8)
        struct std::ctype_base::std::ctype<wchar_t>::VTable* var_30_4 = eax_1
...
arg2[1] = arg3.d
fsbase->NtTib.ExceptionList = ExceptionList
void* const __saved_ebp_1 = &data_6e18fb
return arg2
