...
int32_t (* var_c)(void* arg1) = sub_6b7530
TEB* fsbase
...
if (arg1[1] == 0)
    int32_t var_30 = arg5
    sub_451220(arg1, arg2, 1, *arg1, arg1)
    fsbase->NtTib.ExceptionList = ExceptionList
    return arg2
...
if (arg3 == *ecx_2)
    ...
    if (eax_6 != 0)
        ...
        sub_451220(arg1, arg2, 1, arg3, ecx_3)
        fsbase->NtTib.ExceptionList = ExceptionList
        return arg2
else if (arg3 != ecx_2)
    ...
    if (eax_14 != 0 && eax_17 != 0)
        ...
        sub_451220(ecx_12, arg2, 1, arg3, var_34_7)
        fsbase->NtTib.ExceptionList = ExceptionList
        return arg2
    ...
    if (eax_23 != 0)
        ...
        label_451140:
            ...
            if (*(esi_4[2] + 0xd) == 0)
                sub_451220(ecx_12, arg2, 1, edi_2, var_34_7)
                fsbase->NtTib.ExceptionList = ExceptionList
                return arg2
            
        label_4510c5:
            sub_451220(ecx_12, arg2, 0, esi_4, var_34_7)
            fsbase->NtTib.ExceptionList = ExceptionList
            return arg2
else
    char eax_10
    ...
    if (eax_10 != 0)
        ...
        sub_451220(arg1, arg2, 0, *(*arg1 + 8), ecx_3)
        fsbase->NtTib.ExceptionList = ExceptionList
        return arg2
...
void*** eax_29 = arg2
void** var_1c
*eax_29 = *sub_4513d0(arg1, &var_1c, ecx_3)
fsbase->NtTib.ExceptionList = ExceptionList
return eax_29
