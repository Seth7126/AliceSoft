...
if (*arg1 == 0)
    ...
    label_4cab42:
        ...
        while (true)
            ...
            int32_t var_7c_1 = edx_1 + esi_1
            result, ebx_1 = sub_54f5b0(arg1, ecx_1.b)
            
            if (result.b == 0)
                void* const var_18_1 = 0xf
                int32_t var_1c_1 = 0
                char var_2c = 0
                sub_403490(&var_2c, 0x763d00, 0x60)
                int32_t var_8_1 = 0
                var_8_1.b = 1
                char var_44
                sub_45aae0(sub_4b0f20(&var_50, &var_2c, &var_44, &var_50, edx_1, edx_2, ebx_1))
                int32_t var_30
