...
int32_t* result = sub_660ec0(arg3, eax)
int32_t esi_2 = 0x20
...
if (arg4 s> 0x20)
    do
        ...
        int32_t eax_3 = sub_6610a0(eax_2, var_4, ebp, 0, 0, 0, 0)
        int32_t** ecx_2 = *(arg5 + 0x10)
        int32_t esi_3 = esi_2 * 2
        result = sub_661200(eax_3, ecx_2[1], *ecx_2, ebp, esi_3, arg4, arg6)
        esi_2 = esi_3 * 2
    while (esi_2 s< arg4)
