...
for (i = *arg2; i != edx; i = &i[1])
    ...
    *i = xmm1_9
    float xmm0_11 =
        *(edi_1 + (((*(esi_3 + 0x14) + *arg3) & arg3[3]) << 2)) f* *(arg1 + 0x24) + xmm1_9
    *i = xmm0_11
    float xmm1_12 =
        *(edi_1 + (((*(esi_3 + 0x18) + *arg3) & arg3[3]) << 2)) f* *(arg1 + 0x24) + xmm0_11
    *i = xmm1_12
    float xmm2_3 =
        *(edi_1 + (((*(esi_3 + 0x1c) + *arg3) & arg3[3]) << 2)) f* *(arg1 + 0x24) + xmm1_12
    *i = xmm2_3
    *i = *(edi_1 + (((*(esi_3 + 0x20) + *arg3) & arg3[3]) << 2)) f* *(arg1 + 0x24) + xmm2_3
