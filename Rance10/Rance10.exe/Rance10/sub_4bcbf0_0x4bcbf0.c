...
if (i s> 0x20)
    ...
    do
        if (edi_1 s<= 0)
            ...
            sub_4bd0c0(result, ebx)
            return sub_4bd110(result_1, ebx)
        
        int32_t* var_24_1 = arg3
        int32_t* var_10
        sub_4bcce0(result, result, &var_10, ebx)
        int32_t eax_1
        int32_t edx_1
        ...
        if (((var_10 - result_1) & 0xfffffffc) s>= ((ebx - var_c) & 0xfffffffc))
            arg3 = sub_4bcbf0(edi_1, arg5)
            ebx = var_10
            result = result_1
        else
            sub_4bcbf0(edi_1, arg5)
            arg3 = var_c
            result = arg3
            result_1 = result
