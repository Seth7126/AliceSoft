...
int32_t (* var_c)(void* arg1) = sub_72ed1b
TEB* fsbase
struct _EXCEPTION_REGISTRATION_RECORD* ExceptionList = fsbase->NtTib.ExceptionList
int32_t __saved_ebp
int32_t var_28 = __security_cookie ^ &__saved_ebp
fsbase->NtTib.ExceptionList = &ExceptionList
struct thread::CCriticalObject<class std::list<class kiwi::CSoundChannel*> >::VTable** var_14 = arg1
*arg1 = &thread::CCriticalObject<class std::list<class kiwi::CSoundChannel*> >::`vftable'
int32_t* var_18 = &arg1[1]
arg1[1] = 0
arg1[2] = 0
arg1[1] = sub_406950(nullptr, nullptr)
int32_t var_8_1 = 0
