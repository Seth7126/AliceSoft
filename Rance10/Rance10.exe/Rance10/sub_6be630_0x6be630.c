...
int32_t var_428 = esi
uint32_t var_204[0x20][0x4]
_memset(&var_204, 0, 0x200)
uint32_t var_404[0x20][0x4]
                        ...
                        do
                            ...
                            if (eax_14 s>= *(ebx_2 + 4))
                                ...
                                if (eax_14 s< 0 || eax_14 s>= *(ecx_2 + 4))
                                    ...
                                    sub_6b2cf0(arg3, (*(ebx_2 + 0x14))[eax_14], 
                                        (*(ecx_2 + 8))[eax_14])
                                    ebx = var_43c
                        ...
                        if (arg6 s> 0)
                            ...
                            do
                                ...
                                if ((ecx[ecx_4 + 6] & ebp_3) == 0)
                                    ...
                                    if (eax_31 != 0)
                                        int32_t var_450_2 = 0
                                        int32_t eax_35 = sub_6be170(arg3, 
                                            *(eax_23 + esi_4) + (edx_5 << 2), var_434, eax_31)
                                        int32_t* ecx_5 = var_43c
                                        edx_5 = var_408_1
                                        ecx_5[8] += eax_35
                                        int32_t ecx_7 = *(*esi_4 + (edi_1 << 2))
                                        var_204[0][ecx_7] += eax_35
                                        i = i_1
...
@__security_check_cookie@4(eax_1 ^ &var_43c)
return 0
