...
if (eax_3 s<= 0x28)
    if (arg2[2] s< arg3[2])
        sub_4c1400(arg2, arg3)
    
    result = *(arg4 + 8)
    
    if (result s< arg2[2])
        sub_4c1400(arg4, arg2)
        result = arg2[2]
        
        if (result s< arg3[2])
            return sub_4c1400(arg2, arg3) __tailcall
else
    int32_t eax_5
    int32_t edx_3
    ...
    if (*(esi_2 + arg3 + 8) s< arg3[2])
        sub_4c1400(ebp_1, arg3)
    
    if (ecx_1[2] s< ebp_1[2])
        sub_4c1400(ecx_1, ebp_1)
    ...
    if (arg2[2] s< *(esi_4 + 8))
        sub_4c1400(arg2, esi_4)
    
    if (*(ebx_1 + 8) s< arg2[2])
        sub_4c1400(ebx_1, arg2)
    ...
    if (esi_6[2] s< *(ecx_8 + 8))
        sub_4c1400(esi_6, ecx_8)
    
    if (*(arg4 + 8) s< esi_6[2])
        sub_4c1400(arg4, esi_6)
        int32_t* edx_13 = ecx_8
        
        if (esi_6[2] s< edx_13[2])
            sub_4c1400(esi_6, edx_13)
    
    if (arg2[2] s< ebp_1[2])
        sub_4c1400(arg2, ebp_1)
    
    result = esi_6[2]
    
    if (result s< arg2[2])
        sub_4c1400(esi_6, arg2)
        result = arg2[2]
        
        if (result s< ebp_1[2])
            return sub_4c1400(arg2, ebp_1) __tailcall
