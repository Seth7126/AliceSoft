...
int32_t (* var_c)(void* arg1) = sub_6cbc60
TEB* fsbase
...
if (ecx_2 u> arg2)
    ...
    sub_5ef8f0(esi_2, arg2 - ((edx_5 u>> 0x1f) + edx_5))
    int32_t esi_3 = arg1[1]
    int32_t eax_11
    int32_t edx_8
    edx_8:eax_11 = muls.dp.d(0x66666667, esi_3 - *arg1)
    int32_t edx_9 = edx_8 s>> 3
    int32_t eax_16 = esi_3 + (arg2 - ((edx_9 u>> 0x1f) + edx_9)) * 0x14
    arg1[1] = eax_16
    fsbase->NtTib.ExceptionList = ExceptionList
    return eax_16
