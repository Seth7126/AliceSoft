...
void* const var_b8_25 = &data_6d9660
...
if ((arg5[5] & 0x3000) != 0x3000)
    int32_t var_8 = 0
    void var_a4
    int32_t* eax_3 = sub_6d7479(std::ios_base::getloc(arg5, &var_a4))
    ...
    struct std::ctype_base::std::ctype<wchar_t>::VTable* eax_5 =
        sub_633850(std::ios_base::getloc(std::_Mpunct<wchar_t>::grouping(eax_3, &var_64), &var_9c))
    var_8_2.b = 1
    std::_Debug_range2<class std::move_iterator<class std::_Vector_iterator<class std::_Vector_val<struct std::_Simple_types<class std::shared_ptr<struct Concurrency::details::_Task_impl<struct std::pair<uint8_t,class Concurrency::details::_CancellationTokenState*> > > > > > > >(
        &var_9c)
    ...
    j_sub_4033e0()
    int16_t var_34
    esi_2("0123456789-+Ee", 0x7502d3, &var_34)
    int32_t* esi_3 = arg4
    ...
    *edi_3 = 0
    ...
    int32_t* var_b8 = arg6
    result = sub_6da41a(arg1, arg2, arg3, arg4, arg5)

@__security_check_cookie@4(eax_53 ^ &__saved_ebp)
fsbase->NtTib.ExceptionList = ExceptionList
void* const __saved_ebp_1 = &data_6d9cf6
return result
