...
if (result != ebx)
    ...
    char* esi_1 = *result
    int32_t eax_7 = (eax_1 - ebp_1) s/ 0x18
    int32_t eax_8
    int32_t edx_3
    ...
    if (eax_7 u<= eax_11)
        ...
        result[1] = *result + ((edx_6 u>> 0x1f) + edx_6) * 0x18
        return result
    ...
    if (eax_7 u> eax_22)
        ...
        int32_t ecx_18
        eax_27, ecx_18 = sub_4272a0(result, (edx_10 u>> 0x1f) + edx_10)
        
        if (eax_27.b != 0)
            int32_t var_18_4 = ecx_18
            int32_t var_1c_5 = eax_7
            int32_t var_20_5 = ecx_18
            result[1] = sub_568a20(eax_27, ebx[1], *ebx, *result)
    else
        void* esi_3 = &ebp_1[eax_11 * 0x18]
        int32_t ecx_13
        eax_27, ecx_13 = sub_6feca0(*result, ebp_1, esi_3 - ebp_1)
        int32_t var_1c_3 = eax_7
        int32_t var_20_3 = ecx_13
        result[1] = sub_568a20(eax_27, ebx[1], esi_3, result[1])
