...
uint64_t xmm7_1[0x2] = _mm_and_pd(data_714f50, arg1)
...
((*(edx_3 * 9 + 0x714688) * xmm2_4 f+ *(edx_3 * 9 + 0x714680)) * xmm2_5
    + *(edx_3 * 9 + 0x714678) * xmm2_4 f+ *(edx_3 * 9 + 0x714670)) * xmm2_5 * xmm2_5
    + (*(edx_3 * 9 + 0x714668) * xmm2_4 f+ *(edx_3 * 9 + 0x714660)) * xmm2_5
    + *(edx_3 * 9 + 0x714658) * xmm2_4 + *(edx_3 * 9 + 0x714650)
*(edx_3 * 9 + 0x714690)
return edx_3 * 9 + 0x714650
