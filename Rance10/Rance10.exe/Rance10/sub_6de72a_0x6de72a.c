...
int32_t (* var_c)(void* arg1) = sub_749ccb
TEB* fsbase
...
void* const var_108_13 = &data_6de739
...
if (arg3 == 0)
    var_8.b = 2
    void var_ac
    int32_t* eax_5 = sub_6d70cb(std::ios_base::getloc(arg4, &var_ac))
    edi_1 = eax_5
    var_7c = eax_5
    ecx_3 = &var_ac
else
    var_8.b = 1
    void var_a4
    edi_1 = sub_6d702e(std::ios_base::getloc(arg4, &var_a4))
    ecx_3 = &var_a4
    var_7c = edi_1
...
if (arg7 u> i_6)
    ...
    sub_6e3437(&arg_20, 0, i_6 - arg7 + 1, ecx_1.w)
...
sub_635110(&var_2c, eax_15)
sub_631740(&var_74, 1, nullptr)
int32_t var_34 = 0
int32_t var_30 = 7
int16_t var_44 = 0
var_8.b = 5
...
if ((*(arg4 + 0x14) & 8) != 0)
    sub_635110(&var_44, sub_6e59c0(edi_1, &var_74))
    sub_631740(&var_74, 1, nullptr)
...
sub_631740(&arg_20, 1, nullptr)
@__security_check_cookie@4(eax_74 ^ &__saved_ebp)
fsbase->NtTib.ExceptionList = ExceptionList
void* const __saved_ebp_1 = &data_6decb0
return arg1
