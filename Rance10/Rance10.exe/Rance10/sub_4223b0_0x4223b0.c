...
struct dpvariable::CRefPageInfo::VTable** ecx_8
...
if (edi u>= edx || ebx_1 u> edi)
    ...
    if (edx == ebx_3)
        ...
        if (result u< 1)
            ...
            result = sub_422630(arg1, edx_6)
    
    ecx_8 = arg1[1]
    arg2 = ecx_8
    struct dpvariable::CRefPageInfo::VTable** var_14_2 = ecx_8
    int32_t var_8_2 = 1
else
    int32_t ecx = arg1[2]
    ...
    if (edx == ecx)
        ...
        if (result u< 1)
            ...
            result = sub_422630(arg1, edx_3)
    
    ecx_8 = arg1[1]
    edi = ((edi - ebx_1) & 0xffffffc0) + *arg1
    arg2 = ecx_8
    struct dpvariable::CRefPageInfo::VTable** var_14_1 = ecx_8
    int32_t var_8_1 = 0

if (ecx_8 != 0)
    result = sub_422f10(ecx_8, edi)
