...
if (arg2 != 1)
    ...
    do
        ...
        int32_t var_4 = 0
        struct dpsound::CWindow::VTable** ebx_1 = sub_69adc6(0x80)
        struct dpsound::CWindow::VTable** var_2c_1 = ebx_1
        var_4.b = 1
        int32_t var_6c
        int32_t var_14
        ...
        if (ebx_1 == 0)
            ...
            edi = var_34
            sub_6956e0(ebx_1, *(edi + 0x20), edi_1, var_6c)
            *ebx_1 = &dpsound::CSplitWindowBorderHeightTuning::`vftable'{for `dpsound::CSplitWindowBorder'}
        ...
        var_38 = ebx_1
        var_6c = eax_8 * ebp
        sub_696020(ebx_1, ecx_1, 0x54000000, 0, var_6c, 0, eax_8, *(edi + 0x1c), nullptr, 
            *(edi + 0x20))
        ebx_1[0x1c] = edi + 0x30
        ebx_1[0x1b] = edi + 0x32
        ebx_1[0x1d] = *(edi + 0x24)
        ...
        *(ebx_1 + 0x7a) = edx_1
        ...
        if (&var_38 u>= ecx_4 || eax_13 u> &var_38)
            ...
            struct dpsound::CWindow::VTable*** eax_16 = esi_1[1]
