...
int32_t var_3c = 0
var_4c = 0
sub_402110(&var_4c, "DPAnalysis_FuncStackWnd", 0x17)
int32_t var_c_1 = 0
...
int32_t var_24 = 0
char var_34 = 0
sub_402110(&var_34, 0x6da013, nullptr)
int32_t var_c_3 = 1
...
void* eax_5 = *(arg1 + 8)
*(eax_5 + 0x6c) = 0x80000000
*(eax_5 + 0x70) = 0x80000000
*(eax_5 + 0x74) = 0xc8
*(eax_5 + 0x78) = 0x80000000
*(*(arg1 + 8) + 0x64) = 0x200
void* result = *(arg1 + 8)
*(result + 0x68) = 0x54000000
fsbase->NtTib.ExceptionList = ExceptionList
