...
int32_t (* var_c)(void* arg1) = sub_6c3590
TEB* fsbase
...
if (ecx_2 u> arg2)
    ...
    sub_529560(arg1, arg2 - ecx_2)
    int32_t var_8_1 = 0
    void* esi_2 = arg1[1]
    int32_t var_2c_1 = arg2
    int32_t eax_7
    int32_t edx_4
    edx_4:eax_7 = muls.dp.d(0x2e8ba2e9, esi_2 - *arg1)
    int32_t edx_5 = edx_4 s>> 3
    sub_5297e0(esi_2, arg2 - ((edx_5 u>> 0x1f) + edx_5))
    int32_t eax_11
    int32_t edx_8
    edx_8:eax_11 = muls.dp.d(0x2e8ba2e9, arg1[1] - *arg1)
    int32_t edx_9 = edx_8 s>> 3
    int32_t eax_15 = (arg2 - ((edx_9 u>> 0x1f) + edx_9)) * 0x2c
    arg1[1] += eax_15
    fsbase->NtTib.ExceptionList = ExceptionList
    return eax_15
