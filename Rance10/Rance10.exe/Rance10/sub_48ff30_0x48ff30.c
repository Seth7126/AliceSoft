...
int32_t var_24_1 = (*(*arg3 + 0xc))("bandwidth", 0, eax_4)
(*(*arg3 + 0xc))("freq", 0)
struct kiwi::CBiquadFilterProcess::kiwi::CBandPassFilterProcess::VTable** result =
    sub_48ca40(eax_3, fconvert.s(arg2), fconvert.s(arg1))
fsbase->NtTib.ExceptionList = ExceptionList
return result
