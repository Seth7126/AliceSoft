...
if (edi u> esi && edi u< count + esi)
    int128_t* esi_5 = count + esi
    int128_t* edi_1 = count + edi
    
    if (count u>= 0x20)
        if (test_bit(data_7e1080, 1))
            while ((edi_1 & 0xf) != 0)
                count -= 1
                esi_5 -= 1
                edi_1 -= 1
...
label_6ff19b:
    ...
    if (count u>= 0x80)
        ...
        if (((edi ^ esi) & 0xf) == 0 && test_bit(data_7e1080, 1))
            void* eax_16 = esi & 0xf
        ...
        if (not(test_bit(data_7fc260, 0)) || (edi & 3) != 0)
            goto label_6feec7
        ...
        switch (count)
            ...
            case 3
                goto label_6fef3c
    else if (test_bit(data_7e1080, 1))
    label_6ff16d:
