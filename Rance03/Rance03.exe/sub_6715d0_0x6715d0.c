...
struct dpparts::CListHeaderParts::VTable** ebx

if (edi u>= result || arg1 u> edi)
    if (result == esi[2])
        int32_t* var_24_2 = arg1
        result = sub_6716a0(esi)
    
    ebx = esi[1]
    arg2 = ebx
    struct dpparts::CListHeaderParts::VTable** var_10_2 = ebx
    int32_t var_4_1 = 1
else
    if (result == esi[2])
    ...
    arg2 = ebx
    struct dpparts::CListHeaderParts::VTable** var_10_1 = ebx
    int32_t var_4 = 0

if (ebx != 0)
    *ebx = &dpparts::CListHeaderParts::`vftable'
    ebx[6] = 0xf
    ebx[5] = 0
    ebx[1].b = 0
