...
int128_t* eax
int32_t ecx
eax, ecx = sub_568720(arg2)
int32_t var_14_1 = ecx
int32_t var_18 = arg2
int32_t var_1c = ecx
sub_568a50(eax, arg1[1], *arg1, eax)
int32_t eax_1
int32_t edx_1
...
if (eax_2 != 0)
    ...
    sub_403160(*arg1, (edx_4 u>> 0x1f) + edx_4, 0x14)

arg1[2] = eax + arg2 * 0x14
void* result = eax + ((edx_2 u>> 0x1f) + edx_2) * 0x14
arg1[1] = result
*arg1 = eax
return result
