...
do
    int16_t* ebx_1 = ebx + *(arg1 + 0x20)
    int16_t* edx_1 = *(arg4 + 0x20) + ((edx + ebp) << 1)
    int16_t* edi_2 = *(arg6 + 0x20) + ((edx + esi) << 1)
    ...
    *ebx_1 += ((eax_18 - edx_4) s>> 1).w
    void* ebx_3 = *(arg1 + 0x20) + arg5
    int16_t* edx_5 = *(arg4 + 0x20) + ((ebp + 1 + arg2) << 1)
    int16_t* edi_5 = *(arg6 + 0x20) + ((arg2 + 1 + esi) << 1)
    ...
    *(ebx_3 + 2) += ((eax_37 - edx_8) s>> 1).w
    int32_t ebx_4 = *(arg1 + 0x20)
    int16_t* edx_9 = *(arg4 + 0x20) + ((ebp + 2 + arg2) << 1)
    int16_t* edi_8 = *(arg6 + 0x20) + ((arg2 + 2 + esi) << 1)
    ...
    *(ebx_4 + arg5 + 4) += ((eax_56 - edx_12) s>> 1).w
    int32_t ebx_5 = *(arg1 + 0x20)
    int16_t* edx_13 = *(arg4 + 0x20) + ((ebp + 3 + arg2) << 1)
    int16_t* edi_11 = *(arg6 + 0x20) + ((arg2 + 3 + esi) << 1)
    ...
    *(ebx_5 + arg5 + 6) += ((eax_75 - edx_16) s>> 1).w
    int32_t ebx_6 = *(arg1 + 0x20)
    int16_t* edx_17 = *(arg4 + 0x20) + ((ebp + 4 + arg2) << 1)
    int16_t* edi_14 = *(arg6 + 0x20) + ((arg2 + 4 + esi) << 1)
    ...
    *(ebx_6 + arg5 + 8) += ((eax_94 - edx_20) s>> 1).w
    int32_t ebx_7 = *(arg1 + 0x20)
    int16_t* edx_21 = *(arg4 + 0x20) + ((ebp + 5 + arg2) << 1)
    int16_t* edi_17 = *(arg6 + 0x20) + ((arg2 + 5 + esi) << 1)
    ...
    *(ebx_7 + arg5 + 0xa) += ((eax_113 - edx_24) s>> 1).w
    ...
    int16_t* edx_25 = *(arg4 + 0x20) + ((ebp + 6 + arg2) << 1)
    int16_t* edi_20 = *(arg6 + 0x20) + ((arg2 + 6 + esi) << 1)
    ...
    *(ebx_8 + arg5 + 0xc) += ((eax_132 - edx_28) s>> 1).w
    int32_t ebx_9 = *(arg1 + 0x20)
    int16_t* edx_29 = *(arg4 + 0x20) + ((ebp + 7 + arg2) << 1)
    int16_t* edi_23 = *(arg6 + 0x20) + ((arg2 + 7 + esi) << 1)
