...
int32_t var_1c = 0
char var_2c = 0
sub_402110(&var_2c, "DPPartsChildWindow", 0x12)
int32_t var_4 = 0

if (*(arg1 + 0x58) == 0)
    struct dpparts::CWindow::VTable** eax_5 = sub_69adc6(0x120)
    var_4.b = 1
    struct dpparts::CWindow::dpparts::CChildWindow::VTable** ecx_3
    ...
    if (eax_5 == 0)
        ...
        ecx_3 = sub_652ae0(eax_5, edi_1, ebx_1, ecx_1, eax_10, eax_9, eax_8)
    
    var_4.b = 0
    int32_t eax_12 = *(arg1 + 0x5c)
    *(arg1 + 0x58) = ecx_3
    ecx_3[0xe] = eax_12
    *(*(arg1 + 0x58) + 0x34) = *(arg1 + 0x4c)
