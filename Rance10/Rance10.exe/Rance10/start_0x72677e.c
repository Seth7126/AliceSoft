...
if (eax u> 0x10c5)
    if (eax s<= 0x10c5)
        ...
        return fconvert.t(1.0 - _mm_insert_epi16(arg1, eax_2, 3))
...
double xmm6[0x2] = data_7a2660
double xmm5_2[0x2] = _mm_mul_pd(xmm5_1, xmm0_2)
double xmm0_3[0x2] = _mm_mul_pd(xmm0_2, xmm0_2)
double xmm3_4 = *((((int.d(xmm1) + 0x1c7610) & 0x3f) << 5) + 0x79fc28)
double xmm2_3 = (*(0x79fc10 + (((int.d(xmm1) + 0x1c7610) & 0x3f) << 5))).q f+ xmm3_4
...
double xmm5_3[0x2] = __addpd_xmmpd_mempd(xmm5_2, data_7a2670)
double xmm4_3 = xmm4_2 * *(0x79fc10 + (((int.d(xmm1) + 0x1c7610) & 0x3f) << 5))
double xmm6_2[0x2] = __addpd_xmmpd_mempd(xmm6_1, *"UUUUUU")
double xmm5_4[0x2] = _mm_mul_pd(xmm5_3, xmm0_4)
double xmm3_6 = xmm3_5 f+ *((((int.d(xmm1) + 0x1c7610) & 0x3f) << 5) + 0x79fc18)
double xmm4_4 = xmm4_3 + xmm3_6
double xmm6_3[0x2] = _mm_add_pd(xmm6_2, xmm5_4)
double xmm5_6 = *((((int.d(xmm1) + 0x1c7610) & 0x3f) << 5) + 0x79fc18) - xmm3_6
double xmm1_7 = (xmm1_3 f* 1.2639164054974691e-22 - (xmm4_1 - xmm4_2 f- xmm2_1))
    * (xmm7 * xmm4_2 - xmm2_3) f+ *((((int.d(xmm1) + 0x1c7610) & 0x3f) << 5) + 0x79fc20)
double xmm6_4[0x2] = _mm_mul_pd(xmm6_3, xmm2_5)
return fconvert.t(xmm4_4 + xmm1_7 + xmm5_6 + xmm3_5 + xmm3_6 - xmm4_4 + xmm4_3 f+ xmm6_4
