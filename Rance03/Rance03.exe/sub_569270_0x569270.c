...
if (result != ebx)
    ...
    if (eax_7 u<= eax_11)
        ...
        sub_537d00(sub_569d70(eax_11, ebx[1], esi_1, ebp_1), result[1])
        int32_t eax_13
        int32_t edx_6
    ...
    if (eax_7 u> (edx_9 u>> 0x1f) + edx_9)
        ...
        if (eax_26.b != 0)
            ...
            result[1] = sub_569c60(eax_26, ebx[1], *ebx, *result)
    else
        ...
        result[1] = sub_569c60(eax_26, ebx[1], esi_2, result[1])
