...
void* const var_60_3 = &data_6df66f
...
void* eax_3
int32_t edx
eax_3, edx = std::num_get<uint16_t,class std::istreambuf_iterator<uint16_t,struct std::char_traits<uint16_t> > >::_Getifld(
    arg1, &var_34, &arg_8, &arg_10, *(arg4 + 0x14))
int32_t var_3c
int32_t eax_5 = __Stolx(&var_34, edx, &data_6db1b8, &var_34, &var_3c, eax_3, &var_38)
...
fsbase->NtTib.ExceptionList = ExceptionList
void* const __saved_ebp_1 = &data_6df710
return arg2
