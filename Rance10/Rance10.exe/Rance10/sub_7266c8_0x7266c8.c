...
if (z)
    ...
    if (data_7fcae8 == 0)
        int80_t st0_3
        st0_3, arg1 = __startOneArgErrorHandling(1, 0x20, data_7568b0, 0x7a1040, var_4)
        return 
else
    int16_t x87control
    int16_t x87status_1
    ...
    if (test_bit(arg1:1.b, 2))
        unimplemented  {fld st0, tword [0x7568fa]}
        c1_1 = false
    ...
    if (data_7fcae8 == 0)
        ...
        if (arg1.w != 0x27f)
            ...
            if (arg1.w != 0)
                ...
                if (arg1.w != 0)
                    __startOneArgErrorHandling(8, 0x20, st0_1, 0x7a1040, var_4)
                    unimplemented  {call 0x71a737}
                    return 
