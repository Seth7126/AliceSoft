...
if (eax_7 != 0 && sub_48d400(eax_7, arg1 + 0x19c) != 0)
    ...
    if ((*(**(*(esi_1 + 0x28) + 0xc) + 8))(eax_2) != 0x14)
        ...
        *(*(esi_1 + 0x28) + 0xc) = ecx_6
        *(esi_1 + 0x14) = 1
    
    struct IInterface::partsengine::CFlatData::VTable** eax_18 =
        sub_492050(*(*(esi_1 + 0x28) + 0xc), arg1 + 0x19c)
    fsbase->NtTib.ExceptionList = ExceptionList
    return eax_18
...
if (sub_44a260(eax_19) != 0)
    int32_t* eax_21 = sub_498b80(arg1, arg1 + 0x124, arg1 + 0x1cc, arg1 + 0xa8, 3)
    fsbase->NtTib.ExceptionList = ExceptionList
    return eax_21
...
int32_t eax_26 = sub_498a70(arg1, arg1 + 0x1cc, eax_3, eax_4, arg1 + 0xa8, 1, eax_22, 3)
fsbase->NtTib.ExceptionList = ExceptionList
return eax_26
