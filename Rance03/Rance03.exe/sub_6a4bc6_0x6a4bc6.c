    ...
    if (sbb.d(0x7fffffff, 0x7fffffff, 0x7fffffff u< arg3) != 0xffffffff)
        ...
        if ((*((&data_75ca40)[ebx_2] + edi_3 + 4) & 1) == 0)
            ...
            *___doserrno() = 0
            ...
            result_1 = sub_6a4cda(arg1, arg2, arg3)
...
fsbase->NtTib.ExceptionList = ExceptionList
void* const __saved_ebp_2 = &data_6a4cd9
return result
