...
int32_t (* var_c)(void* arg1) = sub_744b30
TEB* fsbase
...
if (arg1[1] == 0)
    int32_t var_34 = arg5
    sub_625140(arg1, arg2, 1, *arg1, arg1)
    fsbase->NtTib.ExceptionList = ExceptionList
    return arg2
...
if (arg3 == *edi)
    ...
    if (eax_5 != 0)
        ...
        sub_625140(arg1, arg2, 1, arg3, ecx_2)
        fsbase->NtTib.ExceptionList = ExceptionList
        return arg2
else if (arg3 != edi)
    int32_t* ebx_1 = arg4
    ...
    if (sub_412ca0(ebx_1, &arg3[4]) != 0)
        ...
        if (eax_13 != 0)
            ...
            if (*(ebx_2[2] + 0xd) == 0)
                sub_625140(arg1, arg2, 1, arg3, ecx_10)
                fsbase->NtTib.ExceptionList = ExceptionList
                return arg2
            
            sub_625140(arg1, arg2, 0, ebx_2, ecx_10)
            fsbase->NtTib.ExceptionList = ExceptionList
            return arg2
    ...
    if (eax_18 != 0)
        ...
        if (ebx_3 == edi || eax_20 != 0)
            ...
            if (*(arg3[2] + 0xd) == 0)
                sub_625140(arg1, arg2, 1, ebx_3, ecx_2)
                fsbase->NtTib.ExceptionList = ExceptionList
                return arg2
            
            sub_625140(arg1, arg2, 0, arg3, ecx_2)
            fsbase->NtTib.ExceptionList = ExceptionList
            return arg2
else
    void** esi_3 = edi[2]
    ...
    if (eax_8 != 0)
        ...
        sub_625140(arg1, arg2, 0, esi_3, ecx_2)
        fsbase->NtTib.ExceptionList = ExceptionList
        return arg2
...
void*** eax_25 = arg2
void** var_1c
*eax_25 = *sub_6252b0(arg1, &var_1c, ecx_2)
fsbase->NtTib.ExceptionList = ExceptionList
return eax_25
