    ...
    if (eax_2 != arg2)
        ...
        if (arg4 != 0)
            if (zx.d(QueryDepthSList(arg1)) s<= arg1->__offset(0x44).d)
                InterlockedPushEntrySList(arg1, arg2 + 0x34)
            else
                InterlockedPushEntrySList(&arg1[1], arg2 + 0x34)
                
                if (zx.d(QueryDepthSList(&arg1[1])) s> arg1->__offset(0x44).d
                        && (*(arg1->__offset(0x24).d + 0x194) & 0xa0000000) != 0xa0000000)
                    Alignment = 0
                    ...
                    if (Alignment == 0)
                        SLIST_ENTRY* eax_10 = InterlockedFlushSList(&arg1[1])
                        void* var_1c_5 = arg1->__offset(0x24).d
                        arg1->__offset(0x10).d = eax_10
                        sub_6f1a81(arg1 + 0x14, 
                            Concurrency::details::ListArray<class Concurrency::details::ExternalStatistics>::CheckForDeletionBridge, 
                            arg1, var_1c_5)
