...
if (i s> 0x20)
    ...
    do
        if (ebp_1 s<= 0)
            ...
            if (eax_21 s> 1)
                eax_21 = sub_5528e0(eax_21, edi, ebx, arg5)
            
            return sub_552960(eax_21, edi, ebx, arg5)
        
        int32_t* var_c
        sub_551c20(i, ebx, &var_c, edi, arg5)
        int32_t eax_4
        int32_t edx_3
