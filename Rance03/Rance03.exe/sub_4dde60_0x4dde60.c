...
int32_t eax_13 = sub_4a2720(*(*arg1 + 0x1ac))
...
int32_t eax_18 = *(*(*arg1 + 0x1ac) + 0xf0)
...
void* eax_20
eax_20.b = *(*(*arg1 + 0x1ac) + 0xf4)

if (*(arg2 + 0xf4) != eax_20.b)
    *(arg2 + 0xf4) = eax_20.b
    *(arg2 + 0x70) = 1

int32_t edi = *(*arg1 + 0x1ac)
var_58 = edi
...
int32_t eax_57 = *(*(*arg1 + 0x1ac) + 0xb0)

if (*(arg2 + 0xb0) != eax_57)
    *(arg2 + 0xb0) = eax_57
    *(arg2 + 0x70) = 1

int32_t eax_60 = *(*(*arg1 + 0x1ac) + 0xf8)
...
int32_t var_4c
char* eax_61 = sub_4a3390(*(*arg1 + 0x1ac), &var_4c, 2)
int32_t var_c_1 = 0
...
int32_t var_34
char* eax_63 = sub_4a3390(*(*arg1 + 0x1ac), &var_34, 3)
int32_t var_c_3 = 1
