...
int32_t var_1c = 0
char var_2c = 0
sub_402110(&var_2c, "DPPartsTabWindow", 0x10)
int32_t var_4 = 0

if (*(arg1 + 0x5c) == 0)
    struct dpparts::CWindow::VTable** eax_5 = sub_69adc6(0xe4)
    var_4.b = 1
    struct dpparts::CWindow::dpparts::CTabWindow::VTable** ecx_3
    ...
    if (eax_5 == 0)
        ...
        ecx_3 = sub_680f20(eax_5, edi_1, ebx_1, ecx_1, eax_10, eax_9, eax_8)
    
    var_4.b = 0
    *(arg1 + 0x5c) = ecx_3
    ecx_3[0x15] = arg1 + 0x50
    sub_681920()

void* ecx_4 = *(arg1 + 0x5c)
...
if (*(ecx_4 + 8) == 0)
    ...
    sub_684fb0(ecx_4, edx_1, 0x56000000, 0, 0, *(arg1 + 0x3c), *(arg1 + 0x40), arg2, nullptr, 
        *(*(arg1 + 4) + 0x14))
