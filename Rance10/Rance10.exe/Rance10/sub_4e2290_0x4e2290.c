...
int32_t* eax_5 = *(arg1 + 0x20c)
void* eax_7 = *(*(arg1 + 0x220) + 8)

if (eax_7 != 0 && sub_4d62f0(eax_7, arg1 + 0x19c) != 0)
    void* esi_1 = *(sub_4efcc0(*(arg1 + 0xa0)) + 0x44)
    sub_555e00(esi_1, 0x1a, 2)
    int32_t eax_10 = sub_4dbf90(*(esi_1 + 0x84), arg1 + 0x19c)
    fsbase->NtTib.ExceptionList = ExceptionList
    return eax_10

char* eax_11

if (*(arg1 + 0x138) u< 0x10)
    eax_11 = arg1 + 0x124
else
    eax_11 = *(arg1 + 0x124)

if (sub_44c4e0(eax_11) != 0)
    int32_t* eax_14 = sub_4e2050(arg1, arg1 + 0x124, arg1 + 0x1e4, arg1 + 0xc0, 2)
    fsbase->NtTib.ExceptionList = ExceptionList
    return eax_14
...
if (eax_15 == 0)
    ...
    char var_34_2 = 1
    int32_t (__stdcall* var_30_2)(void* arg1, int32_t arg2, int32_t arg3, int32_t arg4) = sub_519290
    eax_15 = &var_38

int32_t eax_20 = sub_4e1f20(arg1, arg1 + 0x1e4, eax_3, eax_4, arg1 + 0xc0, 1, eax_15, 2)
fsbase->NtTib.ExceptionList = ExceptionList
return eax_20
