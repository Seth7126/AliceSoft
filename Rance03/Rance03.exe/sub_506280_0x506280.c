...
if (result == 0 || arg2 s<= 0 || arg3 s<= 0)
    ...
    if (edi_1 == 0)
        ...
        label_50635a:
            ...
            int32_t eax_18
            int32_t ecx_10
            eax_18, ecx_10 = (*(eax_17 + 0x14))(edi_1)
            int32_t var_38_1 = ecx_10
            int32_t eax_20
            int32_t ecx_12
            eax_20, ecx_12 = (*(*esi_2 + 0x10))(_mm_cvtepi32_ps(zx.o(eax_18)))
            int32_t var_3c_1 = ecx_12
            sub_504090(&arg1[5], esi_2, _mm_cvtepi32_ps(zx.o(eax_20)))
