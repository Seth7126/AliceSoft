...
if (result s> 0)
    float* ecx = edi + (var_4c << 2)
    float* var_48_1 = ecx
    float* var_54_1 = edi + (var_4c << 3)
    int32_t* eax_1 = edi + var_4c * 0xc
    void* i_3 = var_58
    esi = arg5
    int32_t* var_50_1 = eax_1
    float* ecx_1 = ecx
    void* i
    
    do
        float xmm2_2 = *eax_1 + *ecx_1
        int32_t ecx_2 = ebx << 2
        float xmm1_2 = *(edi + (ebx << 2)) + *var_54_1
        esi[ecx_2] = xmm1_2 + xmm2_2
        int32_t ecx_3 = ecx_2 + (edx << 1)
        esi[ecx_2 + (edx << 2) - 1] = xmm1_2 - xmm2_2
        float* eax_4 = var_54_1
        float xmm0_3 = *(edi + (ebx << 2))
        ebx += edx
        var_54_1 = &var_54_1[edx]
        esi[ecx_3 - 1] = xmm0_3 - *eax_4
...
if (edx s>= 2)
    if (edx == 2)
    label_645917:
        int32_t ecx_11 = ebp_1 - 1 + edx
        
        if (result s> 0)
            int32_t eax_40 = edx << 4
            void* ebx_5 = &esi[edx]
            void* edx_2 = &esi[edx * 3]
            float* ebp_6 = edi + ((ecx_11 + (ebp_1 << 1)) << 2)
            result = edi + ((ecx_11 + ebp_1) << 2)
            int32_t* esi_7 = edi + ((ecx_11 - ebp_1) << 2)
            float* edi_5 = edi + (ecx_11 << 2)
            void* i_1
        ...
        if (result s> 0)
            ...
            do
                ...
                if (edx s> 2)
                    ...
                    float* var_38_1 = &esi[ecx_7 + (edx << 1)]
                    void* ebp_5 = arg6 + 4
