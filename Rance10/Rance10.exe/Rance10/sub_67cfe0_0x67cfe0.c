...
if (eax_2 != 0)
    *(arg1 + 0x70)
    var_68 = divs.dp.d(sx.q(rect.bottom - rect.top), *(arg1 + 0x70)) + 1
else
    var_68 = eax_2

int32_t eax_8 = GetScrollPos(arg2, SB_VERT)
int32_t eax_9 = GetScrollPos(arg2, SB_HORZ)
sub_67df50(arg1 + 0x30, *(arg1 + 0x98), eax_9, eax_8, var_68)
PAINTSTRUCT paint
BeginPaint(arg2, &paint)
var_58

if (*(arg1 + 0x98) == 0 || *(arg1 + 0x5c) == 0)
    ...
    BitBlt(paint.hdc, ecx_1, edx_3, var_58:8.d - ecx_1, var_58:0xc.d - edx_3, *(arg1 + 0x5c), 
        ecx_1, edx_3, SRCCOPY)
EndPaint(arg2, &paint)
@__security_check_cookie@4(eax_1 ^ &var_6c)
return 0
