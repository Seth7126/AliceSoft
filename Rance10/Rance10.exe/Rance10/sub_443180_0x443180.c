...
do
    ...
    int16_t* ebx_2 = *(arg4 + 0x20) + ((ecx_7 + result) << 1)
    ...
    *(arg7 + ebp_4 + 4) += ((eax_64 - edx_15) s>> 1).w
    ...
    int16_t* ebx_11 = *(arg4 + 0x20) + ((ecx_2 + arg2) << 1)
    ...
    *(arg7 + ebp_6 + 8) += ((eax_110 - edx_23) s>> 1).w
    ...
    int16_t* ebx_17 = *(arg4 + 0x20) + ((ecx_4 + arg2) << 1)
