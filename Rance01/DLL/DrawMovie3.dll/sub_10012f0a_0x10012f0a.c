...
if (arg1 != 0 && arg2 u> 0)
    ...
    if (arg2 u> eax_2 + 9)
        ...
        if (sub_10003cd0(esi_2, ebx_1, "e+000") != 0)
            int32_t var_34
        ...
        if ((data_100224d0 & 1) != 0 && *(esi_2 + 2) == 0x30)
            sub_100038e0(esi_2 + 2, esi_2 + 3, 3)
