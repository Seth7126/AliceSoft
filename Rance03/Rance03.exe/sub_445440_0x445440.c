...
do
    ...
    *(edi_3 + 2) += ((eax_23 + (edx_5 & 3)) s>> 2).w
    void* ebx_13 = *(var_38 + 0x24) + (arg2 << 1)
    void* edi_5 = *(arg4 + 0x24)
    ...
    *(ebx_13 + 4) += ((eax_34 + (edx_8 & 3)) s>> 2).w
    void* edi_6 = *(arg4 + 0x24)
    void* ebx_14 = *(var_38 + 0x24) + (arg2 << 1)
    ...
    *(ebx_14 + 6) += ((eax_46 + (edx_11 & 3)) s>> 2).w
    void* edi_7 = *(arg4 + 0x24)
    void* ebx_15 = *(var_38 + 0x24) + (arg2 << 1)
    ...
    *(ebx_15 + 8) += ((eax_58 + (edx_14 & 3)) s>> 2).w
    void* edi_8 = *(arg4 + 0x24)
    void* ebx_16 = *(var_38 + 0x24) + (arg2 << 1)
    ...
    *(ebx_16 + 0xa) += ((eax_70 + (edx_17 & 3)) s>> 2).w
    void* edi_9 = *(arg4 + 0x24)
    void* ebx_17 = *(var_38 + 0x24) + (arg2 << 1)
    ...
    *(ebx_17 + 0xc) += ((eax_82 + (edx_20 & 3)) s>> 2).w
    void* ebx_18 = *(var_38 + 0x24) + (arg2 << 1)
    void* edi_10 = *(arg4 + 0x24)
