// 函数: ?_Fput@?$num_put@DV?$ostreambuf_iterator@DU?$char_traits@D@std@@@std@@@std@@ABA?AV?$ostreambuf_iterator@DU?$char_traits@D@std@@@2@V32@AAVios_base@2@DPBDI@Z
// 地址: 0x6d12b0
// 来自: E:\torrent\AliceSoft\ランス１０\Rance10.exe

int32_t __saved_ebp_2 = 0x5c
int32_t (* var_c)(void* arg1) = sub_7490e1
TEB* fsbase
...
void* const var_80_8 = &data_6d12bc
...
var_4c.b = eax_6.b
void* ebx_2 = _strcspn(arg7, &var_4c)
int32_t var_8 = 0
void var_58
int32_t* eax_9 = sub_6d0f2e(std::ios_base::getloc(arg5, &var_58))
...
var_8_2.b = 2
int32_t* eax_13 = sub_6d1105(std::ios_base::getloc(arg5, &var_58))
var_8_2.b = 1
std::_Debug_range2<class std::move_iterator<class std::_Vector_iterator<class std::_Vector_val<struct std::_Simple_types<class std::shared_ptr<struct Concurrency::details::_Task_impl<struct std::pair<uint8_t,class Concurrency::details::_CancellationTokenState*> > > > > > > >(
    &var_58)
var_8_2.b = 3
...
while (true)
    ...
    ebx_2 -= ecx_17
    sub_6c51e0(&var_2c, ebx_2, 1, var_64.b)
...
if (eax_23 == 0x40)
    ...
    char* var_74_3 = eax_33
    eax_32 = std::num_put<char,class std::ostreambuf_iterator<char,struct std::char_traits<char> > >::_Put(
        ebx_3, &var_58, arg3, arg4)
    ...
    char* var_74_2 = eax_28
    int32_t* eax_29 = std::num_put<char,class std::ostreambuf_iterator<char,struct std::char_traits<char> > >::_Put(
        ebx_3, &var_58, arg3, arg4)
    ...
    eax_32 = std::num_put<char,class std::ostreambuf_iterator<char,struct std::char_traits<char> > >::_Rep(
        ebx_3, &var_58, (*eax_29).b, eax_29[1])
    esi_10 = 0
else
    ebx_3 = arg1
    ...
    char* var_74_1 = eax_27
    eax_32 = std::num_put<char,class std::ostreambuf_iterator<char,struct std::char_traits<char> > >::_Put(
        ebx_3, &var_58, *eax_24, eax_24[1])

char* ecx_22 = *eax_32
arg3 = ecx_22
int32_t edx_2 = eax_32[1]
char* eax_34 = var_2c.d
arg4 = edx_2
