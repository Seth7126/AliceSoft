...
void* const var_48_13 = &data_6e11eb
int32_t var_8_2 = 0xffffffff
fsbase->NtTib.ExceptionList = &ExceptionList
int32_t var_8 = 0
void var_24
struct std::ctype_base::std::ctype<wchar_t>::VTable* eax_1 =
    sub_633850(std::ios_base::getloc(arg6, &var_24))
...
if (sub_6e320e(&arg_8, &arg_e:2) == 0)
    ...
    int32_t esi_3 = *(eax_1->vFunc_0 + 0x10)
    j_sub_4033e0()
    ...
    if (esi_3(4, var_38_1) == 0)
        ...
        struct std::ctype_base::std::ctype<wchar_t>::VTable* var_38_4 = eax_1
...
while (sub_6e320e(&arg_8, &arg_e:2) == 0)
    ...
    int32_t esi_7 = *(eax_1->vFunc_0 + 0x10)
    j_sub_4033e0()
...
int32_t esi_8 = *(eax_1->vFunc_0 + 0x38)
j_sub_4033e0()
...
label_6e13d9:
    ...
    int32_t esi_9 = *(eax_1->vFunc_0 + 0x10)
    j_sub_4033e0()
...
if (eax_22 == 0)
    ...
    int32_t esi_10 = *(eax_1->vFunc_0 + 0x10)
    j_sub_4033e0()
    ...
    if (esi_10(4, var_38_13) != 0)
        if (var_18 == 1 || var_18 == 3)
            ...
            *(arg8 + 0x10) -= 1
            ...
            struct std::ctype_base::std::ctype<wchar_t>::VTable* var_38_15 = eax_1
...
while (sub_6e320e(&arg_8, &arg_e:2) == 0)
    ...
    int32_t esi_14 = *(eax_1->vFunc_0 + 0x10)
    j_sub_4033e0()
...
int32_t esi_15 = *(eax_1->vFunc_0 + 0x38)
j_sub_4033e0()
...
label_6e1571:
    ...
    int32_t esi_16 = *(eax_1->vFunc_0 + 0x10)
    j_sub_4033e0()
...
if (sub_6e320e(&arg_8, &arg_e:2) == 0)
    ...
    int32_t esi_17 = *(eax_1->vFunc_0 + 0x10)
    j_sub_4033e0()
    int32_t* eax_42
    
    if (esi_17(4, var_38_23) != 0)
        if (var_18 == 4)
            struct std::ctype_base::std::ctype<wchar_t>::VTable* var_38_25 = eax_1
            ...
            *(arg8 + 0x10) -= 1
            ...
            struct std::ctype_base::std::ctype<wchar_t>::VTable* var_38_26 = eax_1
...
arg2[1] = arg3.d
fsbase->NtTib.ExceptionList = ExceptionList
void* const __saved_ebp_1 = &data_6e1685
return arg2
