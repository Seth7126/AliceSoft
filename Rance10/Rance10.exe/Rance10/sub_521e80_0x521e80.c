...
int32_t var_8_1 = 0
void* var_2c
sub_4df830(esi_1 + 0xa4, sub_4f7f90(arg1 + 0xcc, &var_2c))
...
int32_t var_8_3 = 1
void* var_44
sub_4dfb40(esi_1 + 0xa4, sub_4f8760(arg1 + 0xcc, &var_44))
int32_t var_30
...
*(esi_1 + 0x218) = 1
*(esi_1 + 0x208) = arg1 + 0x22c
*(esi_1 + 0x20c) = arg1 + 0x244
*(esi_1 + 0x218) = 1
*(esi_1 + 0x210) = arg1 + 0x25c
*(esi_1 + 0x218) = 1
*(esi_1 + 0x214) = arg1 + 0x274
*(esi_1 + 0x218) = 1
fsbase->NtTib.ExceptionList = ExceptionList
