...
if (edi s> 0)
    ...
    do
        ...
        int32_t eax_20 = (*(*((*(ebx + (ecx_1 << 2) + 0x320) << 2) + &data_6f27b4) + 0x14))(edi_1, 
            *(*(eax_3 + 0x30) + (ecx_1 << 2)))
        *var_c_1 = eax_20
        int32_t ecx_3
        ecx_3.b = eax_20 != 0
...
if (*ecx_5 s> 0)
    ...
    do
        ...
        (*(*((*(ebx + (ecx_9 << 2) + 0x520) << 2) + &data_6f86f0) + 0x1c))(edi_1, 
            *(*(eax_3 + 0x34) + (ecx_9 << 2)), var_2c, var_20, esi_2)
        ecx_5 = arg2
        i_2 = i_6 + 1
        var_10_2 += 4
        i_6 = i_2
...
if (esi_3 - 1 s>= 0)
    ...
    do
        ...
        if (i_7 s> 0)
            int32_t* eax_42 = *(edx_7 + (*ebx_7 << 2)) - ecx_11
            int32_t i_3
            
            do
                float xmm0_1 = *ecx_11
                float xmm1_1 = *(eax_42 + ecx_11)
                
                if (xmm0_1 <= 0f)
                    if (xmm1_1 f<= 0)
                        *(eax_42 + ecx_11) = xmm0_1
                        *ecx_11 = xmm0_1 - xmm1_1
                    else
                        *(eax_42 + ecx_11) = xmm1_1 + xmm0_1
                else if (xmm1_1 f<= 0)
                    *(eax_42 + ecx_11) = xmm0_1
                    *ecx_11 = xmm1_1 + xmm0_1
                else
                    *(eax_42 + ecx_11) = xmm0_1 - xmm1_1
...
if (*(edx + 4) s> 0)
    do
        ...
        (*(*((*(ebx + (ecx_12 << 2) + 0x320) << 2) + &data_6f27b4) + 0x18))(edi_1, 
            *(*(eax_3 + 0x30) + (ecx_12 << 2)), (&__saved_edi)[i_4], *(*edi_1 + (i_4 << 2)))
        ecx_5 = arg2
        i_4 += 1
    while (i_4 s< *(edx + 4))
...
if (*(edx + 4) s> 0)
    do
        ...
        sub_640930(eax_52, edx_9, **(eax_3 + (eax_52 << 2) + 0xc), edx_9)
        i_5 += 1
    while (i_5 s< *(edx + 4))
