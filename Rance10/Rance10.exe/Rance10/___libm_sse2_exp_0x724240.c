...
double xmm1[0x2] = data_79d970
double xmm6[0x2] = data_79d960
double var_8 = xmm0
double xmm2[0x2] = data_79d980
double xmm3[0x2] = data_79d990
...
double xmm4[0x2] = data_79d9a0
double xmm3_1[0x2] = _mm_mul_pd(xmm3, xmm1_3)
double xmm5[0x2] = data_79d9b0
...
uint64_t xmm7_3[0x2] = _mm_slli_epi64(_mm_add_epi64(xmm1_2 & data_79d940, data_79d950), 0x2e)
...
var_1e.q = xmm0_7
long double x87_r6 =
    fconvert.t(_mm_or_pd(data_79d930 & not.o(xmm2_4), _mm_slli_epi64(zx.o(eax_5 + 0x3ff), 0x34)))
