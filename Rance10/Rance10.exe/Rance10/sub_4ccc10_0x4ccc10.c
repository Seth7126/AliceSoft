    ...
    *(arg1 + 0xc) = 1f / _mm_cvtepi32_ps(zx.o(*(arg1 + 8)))
    ...
    if (&edx_1[4] u<= *(arg2 + 8))
        ...
        *(arg2 + 4) += 4
        ...
        if (sub_61ec90(arg2, arg1 + 0x14).b != 0 && sub_6c9300(arg2, arg1 + 0x18).b != 0)
            if (sub_6c9300(arg2, arg1 + 0x1c) != 0)
                float xmm0_4 = _mm_cvtepi32_ps(zx.o(*(arg1 + 0x10))) f/ *(arg1 + 0x1c)
                *(arg1 + 0x20) = xmm0_4
                *(arg1 + 0x24) = 1f / xmm0_4
                
                if (sub_61ec90(arg2, arg1 + 0x28) != 0 && sub_61ec90(arg2, arg1 + 0x2c) != 0)
                    return sub_61ec90(arg2, arg1 + 0x30) != 0
