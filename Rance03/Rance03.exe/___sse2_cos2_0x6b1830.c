...
double xmm0[0x2] = arg1 & data_75f0a0
double xmm4[0x2] = data_75f0c0
double xmm0_2[0x2] = __mulpd_xmmpd_mempd(__addpd_xmmpd_mempd(xmm0, data_75f120), data_75f000)
double xmm5[0x2] = data_75f0d0
double xmm6[0x2] = data_75f0e0
double xmm0_3[0x2] = __addpd_xmmpd_mempd(xmm0_2, data_75f0b0)
double xmm0_5[0x2] = __subpd_xmmpd_mempd(__subpd_xmmpd_mempd(xmm0_3, data_75f0b0), data_75f110)
uint32_t result = _mm_movemask_pd(__pcmpgtd_xmmdq_memdq(xmm0, data_75f100))
double xmm2_4[0x2]

if (result != 0)
    int128_t xmm0_18 = arg1 & data_75f0a0
    double var_70[0x2]
    int32_t eax_1
    int16_t x87control
...
double xmm0_6[0x2] = data_75f080
double xmm6_2[0x2] = data_75f070
...
double xmm0_8[0x2] = __addpd_xmmpd_mempd(xmm0_7, data_75f060)
double xmm6_4[0x2] = __addpd_xmmpd_mempd(xmm6_3, data_75f050)
double xmm0_9[0x2] = _mm_mul_pd(xmm0_8, xmm4_3)
double xmm6_5[0x2] = _mm_mul_pd(xmm6_4, xmm4_3)
double xmm0_10[0x2] = __addpd_xmmpd_mempd(xmm0_9, data_75f040)
double xmm6_6[0x2] = __addpd_xmmpd_mempd(xmm6_5, data_75f030)
double xmm0_11[0x2] = _mm_mul_pd(xmm0_10, xmm4_3)
double xmm6_7[0x2] = _mm_mul_pd(xmm6_6, xmm4_3)
double xmm0_12[0x2] = __addpd_xmmpd_mempd(xmm0_11, data_75f020)
