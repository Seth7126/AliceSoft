...
int32_t var_74 = 0
char var_84 = 0
sub_402110(&var_84, "DPPartsDPPartsWindow", 0x14)
int32_t var_4 = 0
...
if (*(arg1 + 0xdc) == 0)
    ...
    var_8c = eax_6
    var_4.b = 1
    struct dpparts::CWindow::dpparts::CDPPartsWindow::VTable** ecx_3
    ...
    if (eax_6 == 0)
        ...
        ecx_3 = sub_663160(var_8c, edi_1, ebx_1, ecx_1, eax_11, eax_10, eax_9)
...
if (*(*(arg1 + 0xdc) + 8) == 0)
    ...
    sub_684fb0(*(arg1 + 0xdc), ecx_4, 0x56000000, 0, *(arg1 + 0x2c), 
