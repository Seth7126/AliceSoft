...
int32_t (* var_c)(void* arg1) = sub_749b66
TEB* fsbase
...
void* const var_74_7 = &data_6dcfde
...
int32_t var_8 = 0
int32_t var_54
int32_t* eax_5 = sub_6d6aa9(std::ios_base::getloc(arg5, &var_54))
...
var_8_2.b = 2
int32_t var_5c
int32_t* eax_9 = sub_6d73dc(std::ios_base::getloc(arg5, &var_5c))
var_8_2.b = 1
...
if (eax_10.b != 0x7f && eax_10.b s> 0)
    ...
    while (true)
        ...
        ebx_1 -= ecx_12
        sub_6e338e(&var_2c, ebx_1, 1, edx_1.w)
...
fsbase->NtTib.ExceptionList = ExceptionList
void* const __saved_ebp_1 = &data_6dd298
return arg2
