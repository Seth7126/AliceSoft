...
int32_t (* var_c)(void* arg1) = sub_73e1fe
TEB* fsbase
...
int32_t eax_8 = ((arg1[1] - *arg1) s>> 2) * 6
...
if (esi == 0)
    int32_t eax_10 = (*(*arg2 + 0x58))(eax_2)
    __seterrormode(&arg1[4])
    int32_t var_8_1 = 0
    ...
    arg1[3] = eax_10
    ___crtSetUnhandledExceptionFilter(&arg1[4])
    __Smtx_lock_shared(&arg1[4])
    esi_2 = arg1[3]
    __Smtx_unlock_shared(&arg1[4])
...
if (esi == 0 && esi_2 == 0)
    ...
    if ((*(*esi_3 + 0x20))(eax_2) s>= eax_8)
        ...
        int32_t var_50_1 = 0
        int32_t var_4c_1 = 0
        sub_452440(&var_54, &var_40, &var_18)
        int32_t var_8_3 = 1
        __Smtx_lock_shared(&arg1[4])
        ...
        if ((*(*edi_3 + 8))(eax_8, esi_5, (var_50_1 - esi_5) s>> 2, 1).b != 0)
            if (esi_5 != 0)
                sub_403160(esi_5, (var_4c_1 - esi_5) s>> 2, 4)
