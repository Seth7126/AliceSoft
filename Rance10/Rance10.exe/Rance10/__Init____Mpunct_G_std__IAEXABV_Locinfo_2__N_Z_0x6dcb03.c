...
void* var_58_1 = eax_1
std::_Mpunct<uint16_t,uint16_t>::_Getvals<uint16_t>(arg1, nullptr)
char eax_4
...
fsbase->NtTib.ExceptionList = ExceptionList
void* const __saved_ebp_1 = &data_6dcbc4
return result
