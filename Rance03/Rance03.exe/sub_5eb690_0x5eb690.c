...
int32_t (* var_8)(void* arg1) = sub_6cb90e
TEB* fsbase
...
var_1a4 = 0
void** lpFileName_1
sub_40d1c0(arg1 + 0x24, arg2, &lpFileName_1, arg1 + 0x24)
int32_t var_4 = 0
...
if (hFindFile == 0xffffffff || (findFileData.dwFileAttributes.b & 0x10) != 0)
    ...
    int32_t ebp_1 = var_190
    int32_t var_18c
    char ecx_1
    
    if (eax_6 == 0 || ebp_1 == var_18c)
        ecx_1 = 1
    else
        ecx_1 = 0
    ...
    if (ecx_1 == 0)
        ...
        if (sub_468d00(&var_1a0, &var_16c).b == 0)
            ebx.b = 0
        else if (sub_40c250(&var_16c, 0x6eb838).b == 0)
            ebx.b = 0
        else if (sub_468b20(&var_1a0, &var_1a4).b == 0)
            ebx.b = 0
        else
            uint32_t edi_1 = var_1a4
            ...
            if (edi_1 u> 4)
                ...
                *(arg1 + 4) = hFindFile.b
                ...
                if (sub_468b20(&var_1a0, arg1 + 8).b == 0)
                    ebx.b = 0
                else if (edi_1 s< 1)
                    *(arg1 + 0xc) = 0
                label_5eb8ad:
                        ...
                        label_5eb8fd:
                            ...
                            label_5eb970:
                                ...
                                if (sub_468b20(&var_1a0, &var_1a4).b == 0)
                                    ...
                                    hFindFile.b = var_1a4 != 0
                                    *(arg1 + 0x11) = hFindFile.b
                                    
                                    if (sub_468b20(&var_1a0, arg1 + 0x14).b == 0)
                                        ebx.b = 0
                                    else if (sub_468b20(&var_1a0, arg1 + 0x18).b == 0)
                                        ebx.b = 0
                                    else if (sub_468b20(&var_1a0, arg1 + 0x1c).b == 0)
                                        ebx.b = 0
                                    else if (sub_468b20(&var_1a0, arg1 + 0x20).b == 0)
                                        ebx.b = 0
                                    else
                                        ebx.b = 1
                            else if (sub_468ab0(&var_1a0, arg1 + 0xf).b == 0)
                                ebx.b = 0
                            else
                                if (sub_468ab0(&var_1a0, arg1 + 0x10).b != 0)
                                    goto label_5eb970
