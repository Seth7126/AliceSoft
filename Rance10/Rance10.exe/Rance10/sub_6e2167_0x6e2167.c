...
void var_3c
int32_t eax_1 = sub_406aa0(&var_3c, 0x28, "%.0Lf")

if (eax_1 s>= 0)
    int32_t var_8 = 0
    void var_74
    struct std::ctype_base::std::ctype<wchar_t>::VTable* eax_3 =
        sub_633850(std::ios_base::getloc(arg5, &var_74))
    ...
    int32_t esi_2 = *(eax_3->vFunc_0 + 0x30)
    j_sub_4033e0()
    int32_t var_44_1 = 0
    ...
    int32_t var_40_1 = 7
    int16_t var_54 = 0
    sub_632bc0(&var_54, eax_1, var_88_4)
    ...
    void* vFunc_0 = eax_3->vFunc_0
    void* var_90_1 = &var_3c
    *(vFunc_0 + 0x2c)
    j_sub_4033e0()
    (*(vFunc_0 + 0x2c))(var_90_1, eax_1 + &var_3c, eax_6)
    sub_631b70(&var_54, i, eax_5.w)
    uint32_t var_88_7 = eax_5
    void var_a0
    sub_631da0(&var_a0, &var_54)
    sub_6de72a(arg1, arg2, arg3, arg4, arg5, arg6, var_60.d)
    sub_631740(&var_54, 1, nullptr)
else
    *arg1 = arg2
    arg1[1] = arg3

void* const __saved_ebp_3 = &data_6e22dd
