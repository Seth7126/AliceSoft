...
int32_t (* var_c)(void* arg1) = sub_6c2c60
TEB* fsbase
...
if (arg2 != 0)
    ...
    if (arg2 u> 0x3ffffff || ebx == 0)
        sub_69a4fc()
        noreturn

int32_t var_8_1 = 0
int32_t var_30_2 = arg2
sub_51e040(eax_3, arg1[1], *arg1, ebx)
int32_t var_8_2 = 0xffffffff
int32_t ecx_1 = arg1[1]
struct _EXCEPTION_REGISTRATION_RECORD** i = *arg1
int32_t eax_8 = (ecx_1 - i) s>> 6
struct _EXCEPTION_REGISTRATION_RECORD*** esi_1

if (i == 0)
    esi_1 = arg1
else
    for (; i != ecx_1; i = &i[0x10])
        (*i)->Next(0)
    
    esi_1 = arg1
    j__free(*esi_1)

void* result = &ebx[eax_8 * 0x10]
esi_1[2] = &ebx[arg2 * 0x10]
esi_1[1] = result
*esi_1 = ebx
fsbase->NtTib.ExceptionList = ExceptionList
return result
