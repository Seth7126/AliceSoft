...
int32_t edi = 0
float xmm3_2 = arg3 * 0.5f
arg3 = xmm3_2
float xmm1_1 = xmm3_2 / arg4
float var_e8 = xmm1_1
...
if (not(arg4 <= 0f))
    ...
    do
        ...
        int32_t ecx_2 = int.d(xmm2 f+ var_ec)
        int32_t var_c0_1 = ecx_2
        int32_t var_b8_1 = ecx_2
        int32_t var_c4_1 = int.d(xmm1_3 + xmm3_2 + arg1)
        int32_t var_bc_1 = int.d(xmm3_2 - xmm1_3 + arg1)
