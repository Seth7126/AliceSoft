...
do
    ...
    int16_t* eax_2 = *(arg1 + 0x14) + ebx
    int32_t ebx_2 = *(arg4 + 0x14)
    ...
    *eax_2 += ((eax_17 - edx_5) s>> 1).w
    ...
    int16_t* eax_23 = *(arg1 + 0x14) + arg7 + 2
    int32_t ebx_3 = *(arg4 + 0x14)
    ...
    *(ecx_26 + arg7 + 8) += ((eax_108 - edx_23) s>> 1).w
    ...
    int32_t edi_10 = *(arg4 + 0x14)
    int32_t edx_25 = *(arg6 + 0x14)
    ...
    *(ecx_32 + arg7 + 0xc) += ((eax_152 - edx_33) s>> 1).w
    ...
    int32_t edi_14 = *(arg4 + 0x14)
    int32_t edx_35 = *(arg6 + 0x14)
