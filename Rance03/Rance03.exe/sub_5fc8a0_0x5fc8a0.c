...
if (ecx != 0)
    ...
    if (result != 0)
        uint128_t xmm2_1 = zx.o(*(arg1 + 0x3c))
        float xmm0_2 = _mm_cvtepi32_ps(zx.o(*(arg1 + 0x38)))
        ...
        *(ecx_1 + 4) = 0
        *(ecx_1 + 8) = 0
        int32_t eax_5 = *(arg1 + 0x40) + *(arg1 + 0x38)
        float xmm2_4 = _mm_cvtepi32_ps(zx.o(*(arg1 + 0x3c)))
        ...
        *(ecx_1 + 0x24) = 0
        int32_t eax_7 = *(arg1 + 0x3c) + *(arg1 + 0x44)
        ...
        *(ecx_1 + 0x40) = 0x3f800000
        result = *(arg1 + 0x3c) + *(arg1 + 0x44)
        float xmm0_8 = _mm_cvtepi32_ps(zx.o(*(arg1 + 0x40) + *(arg1 + 0x38)))
