...
label_70523a:
    ...
    if (result.b == 0)
        ...
        if ((edx_1.b & 0xc) == 0)
            sub_7043fb(&arg1[0x112], 0x20, ebx_3, &arg1[6])
        
        __crt_stdio_output::string_output_adapter<char>::write_string(&arg1[0x112], &var_8, edi_1, 
            &arg1[6], arg1[3])
        int32_t ecx_10 = arg1[8]
        
        if (((ecx_10 u>> 3).b & 1) != 0 && ((ecx_10 u>> 2).b & 1) == 0)
            sub_7043fb(&arg1[0x112], 0x30, ebx_3, &arg1[6])
        
        int32_t var_18_5 = 0
        __crt_stdio_output::output_processor<char,class __crt_stdio_output::stream_output_adapter<char>,class __crt_stdio_output::positional_parameter_base<char,class __crt_stdio_output::stream_output_adapter<char> > >::write_stored_string_tchar(
            arg1)
