...
if (sub_638110(ebx, 1) != 1)
    return 0

void** result_1 = sub_6382a0(arg1, *(ebp + 0x504) << 2)
...
if (*edi s> 0)
    ...
    do
        ...
        if (ecx_5 != 0)
            ...
            int32_t eax_13 = sub_6394e0(edi_1, ebx)
