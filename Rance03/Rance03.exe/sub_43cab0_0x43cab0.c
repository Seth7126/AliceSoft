...
if (var_3c != 0)
    ...
    if (eax_9 s> 0)
        do
            ...
            if (var_54 u>= var_6c)
                int32_t var_34
                char* edx_6 = sub_403070(&var_64, &var_34, var_54 - var_6c, var_6c)
                ...
                int32_t eax_15 = sub_405190(eax_14, edx_6, ecx_16, eax_14)
                bool cond:5_1 = eax_15 == 0
                
                if (eax_15 == 0)
                    if (var_6c u>= esi_3)
                        eax_15.b = var_6c != esi_3
                    else
                        eax_15 = 0xffffffff
...
int32_t eax_17
int32_t edx_7
edx_7:eax_17 = muls.dp.d(0x2aaaaaab, *(ebx + 4) - *ebx)
