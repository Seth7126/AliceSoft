...
do
    ...
    int16_t* ebx_2 = *(arg6 + 8) + ((ecx_7 + esi) << 1)
    ...
    *(arg7 + ebp_4 + 4) += ((eax_64 - edx_12) s>> 1).w
    ...
    int16_t* ebx_11 = *(arg6 + 8) + ((arg2 + 3 + esi) << 1)
    ...
    *(arg7 + ebp_6 + 8) += ((eax_110 - edx_20) s>> 1).w
    ...
    int16_t* ebx_17 = *(arg6 + 8) + ((arg2 + 5 + esi) << 1)
