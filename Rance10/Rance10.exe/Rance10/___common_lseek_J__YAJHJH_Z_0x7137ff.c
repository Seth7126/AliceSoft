...
if (arg1 != 0xfffffffe)
    ...
    if (arg1 s< 0 || arg1 u>= data_7fc918
            || (zx.d(*((&data_7fc718)[ebx_2] + ecx_1 + 0x28)) & 1) == 0)
        *___doserrno() = 0
        *__errno() = 9
        ...
        if ((*((&data_7fc718)[ebx_2] + ecx_1 + 0x28) & 1) != 0)
...
fsbase->NtTib.ExceptionList = ExceptionList
void* const __saved_ebp_2 = &data_7138e9
return result
