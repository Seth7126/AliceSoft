...
do
    void* edi_1 = ecx + esi
    int16_t* eax_4 = *(ebx + 8) + ebp
    int32_t ecx_2 = *(arg6 + 8)
    ...
    int32_t eax_16
    int32_t edx_11
    edx_11:eax_16 = sx.q(sx.d(*(*(arg4 + 8) + ebp + eax_1)) + sx.d((eax_10 s>> 2).w) + 1)
    *eax_4 += ((eax_16 - edx_11) s>> 1).w
    int16_t* eax_22 = *(var_28 + 8) + 2 + arg7
    int32_t ecx_6 = *(arg6 + 8)
    ...
    int32_t eax_38
    int32_t edx_15
    edx_15:eax_38 = sx.q(sx.d(*(*(arg4 + 8) + eax_1 + arg7 + 2)) + 1 + sx.d((eax_31 s>> 2).w))
    *eax_22 += ((eax_38 - edx_15) s>> 1).w
    void* edx_18 = arg2 + 2 + esi
    int32_t ebp_4 = *(var_28 + 8)
    ...
    int32_t eax_57
    int32_t edx_20
    edx_20:eax_57 = sx.q(sx.d(*(*(arg4 + 8) + (arg5 << 1) + 4 + arg7)) + 1 + sx.d((eax_50 s>> 2).w))
    *(arg7 + ebp_4 + 4) += ((eax_57 - edx_20) s>> 1).w
    void* edx_23 = arg2 + 3 + esi
    int32_t ebp_5 = *(var_28 + 8)
    int32_t ecx_14 = *(arg6 + 8)
    ...
    int32_t eax_76
    int32_t edx_25
    edx_25:eax_76 = sx.q(sx.d(*(*(arg4 + 8) + arg7 + (arg5 << 1) + 6)) + 1 + sx.d((eax_69 s>> 2).w))
    *(arg7 + ebp_5 + 6) += ((eax_76 - edx_25) s>> 1).w
    void* edx_28 = arg2 + 4 + esi
    int32_t ebp_6 = *(var_28 + 8)
    ...
    int32_t eax_95
    int32_t edx_30
    edx_30:eax_95 = sx.q(sx.d(*(*(arg4 + 8) + arg7 + (arg5 << 1) + 8)) + 1 + sx.d((eax_88 s>> 2).w))
    *(arg7 + ebp_6 + 8) += ((eax_95 - edx_30) s>> 1).w
    void* edx_33 = arg2 + 5 + esi
    int32_t ebp_7 = *(var_28 + 8)
    int32_t ecx_24 = *(arg6 + 8)
    ...
    int32_t edx_35
    edx_35:eax_114 =
        sx.q(sx.d(*(*(arg4 + 8) + arg7 + (arg5 << 1) + 0xa)) + 1 + sx.d((eax_107 s>> 2).w))
    *(arg7 + ebp_7 + 0xa) += ((eax_114 - edx_35) s>> 1).w
    void* edx_38 = arg2 + 6 + esi
    int32_t ebp_8 = *(var_28 + 8)
    ...
    int32_t edx_40
    edx_40:eax_133 =
        sx.q(sx.d(*(*(arg4 + 8) + arg7 + (arg5 << 1) + 0xc)) + 1 + sx.d((eax_126 s>> 2).w))
    *(arg7 + ebp_8 + 0xc) += ((eax_133 - edx_40) s>> 1).w
    void* edx_43 = arg2 + 7 + esi
    int32_t ebp_9 = *(var_28 + 8)
    int32_t ecx_34 = *(arg6 + 8)
    ...
    int32_t edx_45
    edx_45:eax_152 =
        sx.q(sx.d(*(*(arg4 + 8) + arg7 + (arg5 << 1) + 0xe)) + 1 + sx.d((eax_145 s>> 2).w))
    result = ((eax_152 - edx_45) s>> 1).w
    *(arg7 + ebp_9 + 0xe) += result
    edx_6 = arg3
    ecx = arg2 + edx_6
    ebp = eax_2 + arg7 + 0x10 - 0x10
    i = i_1
    i_1 -= 1
    arg2 = ecx
    arg7 = ebp
