...
int32_t var_60 = edx
int32_t esi = *(eax_5 + ((ecx - 1) << 2) - 4)
int32_t var_64 = esi
arg1[0x7f] = ecx - 2
void* eax_7 = sub_622960(&arg1[0x52], edx)
char* result
...
if (eax_7 != 0)
    void* eax_13 = sub_622960(&arg1[0x52], esi)
    
    if (eax_13 == 0)
        sub_403360(&var_44, 0x76d548)
        int32_t var_8_2 = 2
    ...
    if (sub_5ff490(eax_13, eax_7) != 0)
        result = sub_405d30(&arg1[0x7d], var_60)
    else
        void var_5c
        sub_403360(&var_5c, "CopyPage")
        int32_t var_8_3 = 4
        sub_612230(arg1, "DG_ASSIGN", &var_5c)
        result = sub_403320(&var_5c)
else
    char* result_1 = 0xf
    void* var_34_1 = eax_7
    var_44 = eax_7.b
    sub_403490(&var_44, 0x76d578, 0x20)
    int32_t var_8_1 = 0
