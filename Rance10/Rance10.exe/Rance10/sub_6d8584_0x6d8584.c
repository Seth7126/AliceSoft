...
void* const var_80_3 = &data_6d8590
...
if (arg1 != 0 && *arg1 == 0)
    struct std::locale::facet::std::collate<uint16_t>::VTable** esi_1 = sub_6e810c(0x10)
    struct std::locale::facet::std::collate<uint16_t>::VTable** var_38_1 = esi_1
    int32_t var_8 = 0
    void var_6c
    void var_2c
    ...
    if (esi_1 == 0)
        ...
        int32_t var_80_2 = 3
        ebx = 3
        *esi_1 = &std::collate<uint16_t>::`vftable'{for `std::locale::facet'}
        int32_t eax_3
        int32_t edx_1
...
fsbase->NtTib.ExceptionList = ExceptionList
void* const __saved_ebp_1 = &data_6d8629
return 1
