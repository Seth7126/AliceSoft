...
if (ecx_2 u> arg2)
    ...
    int32_t eax_2 = sub_60d860(esi_1, edi)
    arg1[1] = esi_1
    return eax_2

if (ecx_2 u< arg2)
    int32_t var_14_3 = arg2
    int32_t var_18_2 = sub_60c660(arg1, arg2 - ecx_2)
    int32_t eax_5
    int32_t edx_5
    edx_5:eax_5 = muls.dp.d(0x66666667, arg1[1] - *arg1)
    int32_t edx_6 = edx_5 s>> 4
    sub_60d6f0(arg1[1], arg2 - ((edx_6 u>> 0x1f) + edx_6))
    int32_t eax_6
    int32_t edx_9
    edx_9:eax_6 = muls.dp.d(0x66666667, arg1[1] - *arg1)
    int32_t edx_10 = edx_9 s>> 4
    eax = (arg2 - ((edx_10 u>> 0x1f) + edx_10)) * 0x28
    arg1[1] += eax
