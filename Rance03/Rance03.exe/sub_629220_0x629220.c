...
if (ebp_2 s<= 0 || edx_1 s< 0)
    sub_62a520(arg1, "internal error handling cHRM->XYZ")
    noreturn

int32_t eax_2 = sub_629750(eax_1, edx_1, &var_10, 0x8000, ebp_2)
...
int32_t eax_3 = sub_629750(eax_2, edi_1, &var_c, 0x8000, ebp_2)
...
if (sub_629750(eax_3, eax_1, &var_8, 0x8000, ebp_2) == 0)
    sub_62a520(arg1, "internal error handling cHRM->XYZ")
    noreturn
...
if (ecx_3 + edi_2 + ebx_1 != 0x8000)
    sub_62a520(arg1, "internal error handling cHRM coefficients")
    noreturn
