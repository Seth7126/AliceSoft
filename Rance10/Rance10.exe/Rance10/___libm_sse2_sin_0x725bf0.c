...
double xmm6[0x2] = data_79eca0
double xmm5_2[0x2] = _mm_mul_pd(xmm5_1, xmm0_2)
double xmm0_3[0x2] = _mm_mul_pd(xmm0_2, xmm0_2)
double xmm2_4 = (*(0x79fc10 + (((int.d(xmm1_1) + 0x1c7600) & 0x3f) << 5))).q f+
    *((((int.d(xmm1_1) + 0x1c7600) & 0x3f) << 5) + 0x79fc28)
...
double xmm5_3[0x2] = __addpd_xmmpd_mempd(xmm5_2, data_79ecb0)
*(0x79fc10 + (((int.d(xmm1_1) + 0x1c7600) & 0x3f) << 5))
double xmm6_2[0x2] = __addpd_xmmpd_mempd(xmm6_1, *"UUUUUU")
double xmm5_4[0x2] = _mm_mul_pd(xmm5_3, xmm0_4)
*((((int.d(xmm1_1) + 0x1c7600) & 0x3f) << 5) + 0x79fc18)
...
*((((int.d(xmm1_1) + 0x1c7600) & 0x3f) << 5) + 0x79fc18)
*((((int.d(xmm1_1) + 0x1c7600) & 0x3f) << 5) + 0x79fc20)
double xmm6_4[0x2] = _mm_mul_pd(xmm6_3, xmm2_6)
_mm_unpackhi_pd(xmm6_4, xmm6_4)
return 0x79fc10 + (((int.d(xmm1_1) + 0x1c7600) & 0x3f) << 5)
