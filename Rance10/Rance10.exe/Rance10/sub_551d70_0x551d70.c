...
if (sub_61ed80(arg2, &var_2c) == 0)
    ...
    if (&ecx_1[4] u> *(arg2 + 8))
        ...
        *(arg2 + 4) = &ecx_1[4]
        ...
        if (sub_61ec90(arg2, &var_44) == 0)
            ebx.b = 0
        else
            uint32_t var_3c
            
            if (sub_61ec90(arg2, &var_40) == 0)
                ebx.b = 0
            else
                uint32_t var_38
                
                if (sub_61ec90(arg2, &var_3c) == 0)
                    ebx.b = 0
                else
                    uint32_t var_34
                    ...
                    if (sub_61ec90(arg2, &var_38) == 0)
                        ...
                        if (sub_61ec90(arg2, &var_34) == 0)
                            ...
                            sub_551c90(arg1, var_3c, var_38, var_34, var_30)
                            
                            if (sub_551a00(arg1, &var_2c, edi_7, var_44, var_40) == 0)
                                ebx.b = 0
                            else
                                ebx.b = 1
