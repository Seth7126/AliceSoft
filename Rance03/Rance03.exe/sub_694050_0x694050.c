...
if (arg2 != 1)
    ...
    while (true)
        struct dpsound::CWindow::VTable*** ebx_1 = nullptr
        int32_t esi_1 = 0
        int32_t result_1 = 0
        struct dpsound::CWindow::VTable*** var_54_1 = nullptr
        int32_t var_50_1 = 0
        int32_t ecx = 0
        int32_t var_4 = 0
        int32_t var_4c_1 = 0
        ...
        if (eax_7 != 0)
            ...
            do
                ...
                var_4.b = 1
                struct dpsound::CWindow::VTable** ebp_1 = sub_69adc6(0x80)
                struct dpsound::CWindow::VTable** var_2c_1 = ebp_1
                var_4.b = 2
                int32_t var_94
                int32_t var_14
                ...
                if (ebp_1 == 0)
                    ...
                    sub_6956e0(ebp_1, *(var_5c + 0x20), edi_2, var_94)
                    result_3 = result_1
                    *ebp_1 = &dpsound::CSplitWindowBorderCrossTuning::`vftable'{for `dpsound::CSplitWindowBorder'}
                
                int32_t* edx_2 = &var_28
                var_4.b = 1
                struct dpsound::CWindow::VTable** var_48 = ebp_1
                ...
                sub_696020(ebp_1, edx_2, 0x54000000, ecx_2 * var_44, var_94, ecx_2, ecx_2, 
