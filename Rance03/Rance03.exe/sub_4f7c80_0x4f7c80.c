...
if (result != 0)
    ...
    sub_4ff2c0(&var_40)
    int32_t var_4 = 0
    void* eax_3 = sub_510260(result[0xd], arg13)
    uint128_t xmm1_1 = *(eax_3 + 0x18)
    uint128_t xmm3_1 = *(eax_3 + 0x30)
    int32_t edx = *(eax_3 + 0x14)
    int32_t xmm2_1 = *(eax_3 + 0x28)
    int32_t xmm4_1 = *(eax_3 + 0x2c)
    *arg2 = *(eax_3 + 0x10)
