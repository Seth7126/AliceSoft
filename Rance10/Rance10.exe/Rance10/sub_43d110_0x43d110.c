...
do
    int16_t* ebp_1 = ebp + *(edi + 8)
    int32_t ebx_1 = edx + esi
    int32_t edx_2 = *(arg6 + 8)
    int16_t* edi_1 = *(arg4 + 8) + ((edx + result) << 1)
    ...
    *ebp_1 += ((eax_14 - edx_5) s>> 1).w
    ...
    void* ebp_3 = *(var_28 + 8) + arg7
    int32_t edx_6 = *(arg6 + 8)
    int16_t* edi_2 = *(arg4 + 8) + ((ecx + arg2) << 1)
    ...
    *(ebp_3 + 2) += ((eax_35 - edx_9) s>> 1).w
    ...
    int16_t* edi_3 = *(arg4 + 8) + ((ecx_1 + arg2) << 1)
    ...
    *(arg7 + ebp_4 + 4) += ((eax_56 - edx_13) s>> 1).w
    ...
    int16_t* edi_4 = *(arg4 + 8) + ((ecx_2 + arg2) << 1)
    ...
    *(arg7 + ebp_5 + 6) += ((eax_77 - edx_17) s>> 1).w
    ...
    int16_t* edi_5 = *(arg4 + 8) + ((ecx_3 + arg2) << 1)
    ...
    *(arg7 + ebp_6 + 8) += ((eax_98 - edx_21) s>> 1).w
    ...
    int16_t* edi_6 = *(arg4 + 8) + ((ecx_4 + arg2) << 1)
    ...
    *(arg7 + ebp_7 + 0xa) += ((eax_119 - edx_25) s>> 1).w
    ...
    int32_t edx_26 = *(arg6 + 8)
    int16_t* edi_7 = *(arg4 + 8) + ((ecx_5 + arg2) << 1)
    ...
    *(arg7 + ebp_8 + 0xc) += ((eax_140 - edx_29) s>> 1).w
    ...
    int32_t edx_30 = *(arg6 + 8)
    int16_t* edi_8 = *(arg4 + 8) + ((ecx_6 + arg2) << 1)
