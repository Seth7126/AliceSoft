...
void* var_30 = nullptr
char var_40 = 0
sub_402110(&var_40, 0x6e4e94, 0x11)
int32_t var_4 = 0
char* esi = &var_40
char* edx = &var_40
void* var_60 = arg1
...
if (((*(arg2 + 0x264) - *(arg2 + 0x260)) & 0xfffffffc) s> 0)
    do
        if (i s> 0)
            var_2c = 0xf
            void* var_30_1 = nullptr
            var_40 = 0
            sub_402110(&var_40, 0x6e4ea8, 3)
            int32_t var_4_2 = 1
            char* esi_1 = &var_40
        ...
        uint32_t var_64
        var_64.q = _mm_cvtps_pd(*(*(arg2 + 0x260) + (i << 2)))
        ...
        i += 1
    while (i s< (*(arg2 + 0x264) - *(arg2 + 0x260)) s>> 2)

int32_t var_14 = 0xf
int32_t var_18 = 0
char var_28 = 0
sub_402110(&var_28, 0x6e4fe0, 2)
int32_t var_4_6 = 3
char* esi_3 = &var_28
