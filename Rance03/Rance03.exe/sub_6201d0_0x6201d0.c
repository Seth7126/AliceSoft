...
if ((*(*eax_3 + 0xc))(eax_3, &var_3c, arg1 + 8, 0) s>= 0)
    ...
    if ((*(*eax_5 + 0x2c))(eax_5, 0, var_3c:8.d, &var_48, &var_4c, &var_40, &var_44, 0) s>= 0)
        _memset(var_48, 0, var_4c)
        char* edx_1 = var_40
        
        if (edx_1 != 0)
            _memset(edx_1, 0, var_44)
            edx_1 = var_40
        
        int32_t* eax_6 = *(arg1 + 8)
        int32_t eax_7
        eax_7.b = (*(*eax_6 + 0x4c))(eax_6, var_48, var_4c, edx_1, var_44) s>= 0
