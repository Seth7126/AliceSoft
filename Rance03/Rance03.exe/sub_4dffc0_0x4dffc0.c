...
if (esi - 1 u> 8)
    ...
    switch (esi + &jump_table_4e0068[2]:3)
        case &lookup_table_4e0074, &lookup_table_4e0074[3], &lookup_table_4e0074[6]
            edi_1 = 0
        case &lookup_table_4e0074[1], &lookup_table_4e0074[4], &lookup_table_4e0074[7]
            int32_t eax_8
            int32_t edx_1
            edx_1:eax_8 = sx.q(edi)
            edi_1 = neg.d((eax_8 - edx_1) s>> 1)
        case &lookup_table_4e0074[2], &lookup_table_4e0074[5], &lookup_table_4e0074[8]
            edi_1 = neg.d(edi)

int32_t var_4_1 = 0xffffffff
int32_t result
float xmm0
result, xmm0 = sub_4a1c10(arg1[0x6b])
