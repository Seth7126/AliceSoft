...
if (*(arg1 + 0x6c) == 0)
    ...
    *(arg1 + 0x6c) = eax_6
    ...
    int32_t var_1c_1 = 0
    char var_2c = 0
    sub_402110(&var_2c, "DPSpriteSplitWindow", 0x13)
    int32_t var_4_2 = 1
    int32_t var_3c_1 = *(arg1 + 0x4c)
    int32_t var_40_1 = *(arg1 + 0x38)
    void var_48
    int32_t var_44
    sub_67dc60(*(arg1 + 0x6c), &var_2c, arg2, *(*(arg1 + 4) + 0x14), *(arg1 + 0x30), 
...
if (*(arg1 + 0x70) != 0)
    sub_67e3d0(*(arg1 + 0x6c), *(arg1 + 0x74), 0, 0)
    sub_67e3d0(*(arg1 + 0x6c), *(arg1 + 0x70), 0, 1)
    result.b = 1
else
    result.b = 0
