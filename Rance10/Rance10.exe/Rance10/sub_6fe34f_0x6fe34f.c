...
label_6fe38b:
    ...
    while (true)
        ...
        if (eax_3 == 0 || result.b == 0)
            ...
            if (eax_4 == 0)
                eax_5 = Concurrency::details::WorkSearchContext::GetRealizedChore(arg2, ebx_1, arg5)
    ...
    result = Concurrency::details::WorkSearchContext::GetRealizedChoreWithinGroup(arg1, arg2, arg4, 
        arg5, arg6, arg8)
