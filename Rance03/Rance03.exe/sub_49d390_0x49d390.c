...
if (ecx != 0 && sub_48d400(ecx, arg1 + 0x1f0) != 0)
    ...
    struct IInterface::partsengine::CFlatData::VTable** eax_14 =
        sub_492050(*(*(esi_1 + 0x28) + 4), arg1 + 0x1f0)
    fsbase->NtTib.ExceptionList = ExceptionList
    return eax_14

void* eax_15

if (*(arg1 + 0x15c) u< 0x10)
    eax_15 = arg1 + 0x148
else
    eax_15 = *(arg1 + 0x148)
...
if (eax_16 != 0)
    ...
    struct _EXCEPTION_REGISTRATION_RECORD** eax_18 =
        sub_4fe4a0(*(*(esi_2 + 0x28) + 4), arg1 + 0x148, nullptr)
    fsbase->NtTib.ExceptionList = ExceptionList
    return eax_18
...
if (*(arg1 + 0x254) != 0)
    ...
    int32_t (__stdcall* var_1c_1)(void* arg1, int32_t arg2, int32_t arg3, int32_t arg4) = sub_4d2ff0
